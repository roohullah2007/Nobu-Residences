...
function ApiKeys({ title, api_keys, mls_settings, connection_status, status, global_tracking_scripts = "" }) {
  ...
  return /* @__PURE__ */ jsx(AdminLayout, { title, children: /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
    ...
    activeTab === "api_keys" && /* @__PURE__ */ jsx("div", { className: "bg-white shadow rounded-lg", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6 p-6", children: [
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-6", children: apiKeysConfig.map((config) => /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        config.id === "resend_api_key" && /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
          /* @__PURE__ */ jsx(
            SecondaryButton,
            {
              type: "button",
              ...
              children: sendingTestEmail ? "Sending…" : "Send test email"
            }
          ),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500", children: 'Sends a test email through Resend to your admin address. Save the key first. The "from" address is MAIL_FROM_ADDRESS — it must belong to a domain verified in Resend.' }),
          /* @__PURE__ */ jsx(InputError, { message: errors.test_email, className: "mt-2" })
        ] })
      ] }, config.id)) }),
      /* @__PURE__ */ jsxs("div", { className: "pt-6 border-t border-gray-200", children: [
        /* @__PURE__ */ jsx(InputLabel, { htmlFor: "global_tracking_scripts", value: "Global Tracking Pixel (Follow Up Boss)" }),
        /* @__PURE__ */ jsxs("p", { className: "mt-1 text-sm text-gray-500", children: [
          "Raw HTML/JS snippet rendered in the ",
          /* @__PURE__ */ jsx("code", { className: "font-mono", children: "<head>" }),
          " of",
          " ",
          /* @__PURE__ */ jsx("strong", { children: "every" }),
          " public website (all sites, all pages) — in addition to each website's own Tracking Scripts field. Use it for the Follow Up Boss pixel so leads and form activity across all sites are captured into FUB. Leave empty to disable."
        ] }),
        /* @__PURE__ */ jsx(
          "textarea",
          {
        ...
        /* @__PURE__ */ jsx(InputError, { message: errors.global_tracking_scripts, className: "mt-2" })
      ] }),
