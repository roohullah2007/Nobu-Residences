...
import PropertyEnquiryModal from "./PropertyEnquiryModal-B-2F22ND.js";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "max-w-[1280px] mx-auto px-0 py-0", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row gap-0 md:gap-[17px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex gap-0 md:gap-[17px] flex-1 order-1 lg:order-none relative", children: [
        /* @__PURE__ */ jsx("div", { className: "hidden lg:block relative flex-1 min-w-0 xl:flex-none xl:w-[619px] h-[645px]", children: images.length > 0 ? /* @__PURE__ */ jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex justify-between flex-col w-[318px] flex-none h-[645px]", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "w-full md:w-[309px] h-auto lg:h-[645px] bg-white border border-gray-200 rounded-xl flex-shrink-0 order-2 lg:order-none mt-4 md:mt-0", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-between p-4 md:p-6 h-full min-h-[500px] lg:min-h-0", children: [
