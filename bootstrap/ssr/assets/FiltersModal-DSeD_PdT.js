...
const FiltersModal = ({
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-black/30 flex items-center justify-center p-4 z-[200]", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-xl w-full max-w-[650px] max-h-[90vh] flex flex-col font-['Work_Sans']", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-100", children: [
      /* @__PURE__ */ jsx("div", {}),
    ...
    /* @__PURE__ */ jsxs("div", { className: "overflow-y-auto overflow-x-hidden flex-1 px-4 sm:px-6 py-5 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "px-2.5", children: /* @__PURE__ */ jsxs("div", { className: "relative flex w-full items-center h-5", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2 px-4 sm:px-6 py-4 border-t border-gray-100", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: handleReset,
