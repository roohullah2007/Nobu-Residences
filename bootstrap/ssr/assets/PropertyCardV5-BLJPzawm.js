      ...
      "a",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: `flex flex-col flex-grow items-start ${config.content} box-border`, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-start gap-2 w-full flex-grow", children: [
              ...
              property.source === "building" && (() => {
                const developerUrl = property.developerSlug || property.developerId ? `/developer/${property.developerSlug || property.developerId}` : null;
                return /* @__PURE__ */ jsx("div", { className: `flex items-center justify-start w-full h-8 min-h-8 pb-2 border-b border-gray-200 font-work-sans font-normal text-sm leading-6 tracking-tight text-gray-600 min-w-0`, children: property.developer ? /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx("span", { className: "text-gray-500 whitespace-nowrap", children: "By " }),
                  developerUrl ? /* @__PURE__ */ jsx(
                    "a",
                    {
                      href: developerUrl,
                      onClick: (e) => {
                  ...
                  ) : /* @__PURE__ */ jsx("span", { className: "text-[#293056] font-medium truncate", children: property.developer })
              ...
              property.source === "building" ? (
                ...
                /* @__PURE__ */ jsx("div", { className: `flex items-center justify-start w-full min-h-8 mt-auto font-work-sans font-normal text-sm leading-6 tracking-tight text-[#293056]`, children: `${property.unitsForSale ?? "—"} Condos for Sale | ${property.unitsForRent ?? "—"} Condos for Rent` })
              ) : (
