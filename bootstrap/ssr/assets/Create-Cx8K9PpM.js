...
function BlogCategoryCreate() {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Create Blog Category", children: [
    /* @__PURE__ */ jsx(Head, { title: "Create Blog Category" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "mb-6", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Create Blog Category" }),
        /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-gray-600", children: "Add a new category to organize your blog posts." })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "bg-white shadow rounded-lg", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 px-6 py-3 flex items-center justify-end space-x-3 rounded-b-lg", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
