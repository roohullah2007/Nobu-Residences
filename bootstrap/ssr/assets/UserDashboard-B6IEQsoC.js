...
import UserFavouritesTab from "./UserFavouritesTab-COl44fr_.js";
...
function UserDashboard({ auth, siteName, siteUrl, year, website }) {
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { siteName, siteUrl, year, auth, website, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-[1280px] mx-auto px-4 md:px-0 py-8", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "border-b border-gray-200 mb-8", children: /* @__PURE__ */ jsx("nav", { className: "flex space-x-8 overflow-x-auto", children: tabs.map((tab) => /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          className: `py-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === tab.id ? "" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"} transition-colors`,
        ...
        activeTab === "profile" && /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "max-w-2xl", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex space-x-4", children: [
              /* @__PURE__ */ jsx("button", { className: "px-4 py-2 rounded-lg font-medium hover:opacity-90 transition-all", style: { backgroundColor: buttonPrimaryBg, color: buttonPrimaryText }, children: "Save Changes" }),
