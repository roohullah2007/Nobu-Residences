...
function ContactForm({ website }) {
  ...
  if (submitStatus === "success") {
    return /* @__PURE__ */ jsx("div", { className: "bg-white rounded-2xl shadow-lg p-8", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-lg p-8", children: [
