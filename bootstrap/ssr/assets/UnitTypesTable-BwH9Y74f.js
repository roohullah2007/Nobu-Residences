      ...
      rows.map((r, i) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-[14px] text-neutral-600 text-center", children: /* @__PURE__ */ jsx("span", { className: "inline-flex items-center justify-center w-8 h-8 bg-gold-50 text-gold-700 rounded-full font-semibold text-sm", children: r.count }) }),
