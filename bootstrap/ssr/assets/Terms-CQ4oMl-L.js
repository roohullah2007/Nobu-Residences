...
import TermsContent from "./TermsContent-D-9Lrfq1.js";
...
function Terms({ auth, siteName, siteUrl, year, website }) {
  return /* @__PURE__ */ jsxs(MainLayout, { siteName, siteUrl, year, website, auth, blueHeader: true, children: [
    /* @__PURE__ */ jsx(Head, { title: `Terms of Service - ${siteName}` }),
    /* @__PURE__ */ jsx("div", { className: "idx mx-auto overflow-hidden bg-primary", children: /* @__PURE__ */ jsxs("div", { className: "px-4 md:px-0 max-w-[1024px] mx-auto pt-12 md:pt-16", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-10", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsx("h1", { className: "font-space-grotesk font-bold text-3xl md:text-5xl leading-tight tracking-[-0.03em] text-[#293056] mb-4", children: "Terms of Service" }),
        /* @__PURE__ */ jsx("p", { className: "font-work-sans font-normal text-lg leading-7 tracking-[-0.03em] text-gray-600 max-w-2xl mx-auto", children: "Please read these terms and conditions carefully before using our services." }),
      ...
      /* @__PURE__ */ jsx("div", { className: "mb-12", children: /* @__PURE__ */ jsx(TermsContent, { website, siteName }) })
    ] }) })
  ] });
}
export {
