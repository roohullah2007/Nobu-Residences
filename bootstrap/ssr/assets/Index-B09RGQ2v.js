      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `bg-white rounded-lg border p-4 text-left transition-colors hover:border-[#cbd5e1] ${statusFilter === "all" && featuredFilter === "all" ? "border-[#0f172a] ring-1 ring-[#0f172a]" : "border-[#e2e8f0]"}`,
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `bg-white rounded-lg border p-4 text-left transition-colors hover:border-[#cbd5e1] ${statusFilter === "active" ? "border-[#16a34a] ring-1 ring-[#16a34a]" : "border-[#e2e8f0]"}`,
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `bg-white rounded-lg border p-4 text-left transition-colors hover:border-[#cbd5e1] ${featuredFilter === "featured" ? "border-[#ca8a04] ring-1 ring-[#ca8a04]" : "border-[#e2e8f0]"}`,
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
