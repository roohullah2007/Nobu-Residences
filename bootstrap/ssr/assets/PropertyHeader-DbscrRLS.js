...
function PropertyHeader({
  ...
  useEffect(() => {
    ...
    fetch(`/api/building-alerts/status?building_id=${encodeURIComponent(buildingId)}`, {
      ...
      if (d?.success) setAlertsOn(!!d.subscribed);
    }).catch(() => {
    });
  ...
  const handleAlertsClick = async (e) => {
    ...
    try {
      ...
      if (d?.success) {
        ...
        setAlertsToast(d.subscribed ? "Alerts on — we'll email you when new listings appear in this building." : "Alerts turned off for this building.");
        setTimeout(() => setAlertsToast(""), 4e3);
      }
    } catch (err) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "bg-white", children: /* @__PURE__ */ jsx("div", { className: `max-w-[1280px] mx-auto md:px-0 ${type === "building" ? "pt-8" : ""}`, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse md:flex-row justify-between items-start gap-5", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex w-full md:w-auto justify-between md:justify-start items-center gap-3 flex-shrink-0", children: [
        ...
        isBuilding && /* @__PURE__ */ jsxs(
          "button",
          {
            onClick: handleAlertsClick,
            disabled: alertsLoading,
            title: alertsOn ? "Turn off alerts for this building" : "Email me when new listings appear in this building",
            className: `flex justify-center items-center gap-2 px-4 sm:px-6 h-[33px] border rounded-[10px] font-work-sans font-medium text-sm transition-all duration-200 whitespace-nowrap ${alertsOn ? "bg-blue-50 border-blue-200 text-[#293056] hover:bg-blue-100" : "bg-white border-[#717680] text-[#252B37] hover:bg-gray-50"} ${alertsLoading ? "opacity-50 cursor-not-allowed" : ""}`,
            children: [
              alertsLoading ? /* @__PURE__ */ jsx("div", { className: "w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin" }) : /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: alertsOn ? "currentColor" : "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" }) }),
    ...
    alertsToast && /* @__PURE__ */ jsx("div", { className: "fixed top-4 right-4 z-[1000000]", children: /* @__PURE__ */ jsxs("div", { className: "bg-blue-50 border border-blue-200 rounded-lg px-4 py-3 shadow-lg max-w-sm flex items-start gap-2", children: [
      /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 text-[#293056] mt-0.5 flex-shrink-0", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" }) }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-[#293056]", children: alertsToast })
    ] }) }),
