...
const BlogCategoriesSection = ({ categories = [] }) => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "py-8", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1280px] mx-auto px-4 md:px-0", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8", children: displayCategories.map((category) => /* @__PURE__ */ jsx(BlogCategoryCard, { category }, category.id)) })
  ] }) });
};
...
export {
  BlogCategoriesSection as default
};
