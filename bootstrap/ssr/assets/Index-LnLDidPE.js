...
function Index({ auth }) {
  ...
  const filteredWebsites = useMemo(() => {
    ...
    return (websites || []).filter((website) => {
      ...
      if (!q) return true;
      return (website.name || "").toLowerCase().includes(q) || (website.slug || "").toLowerCase().includes(q) || (website.domain || "").toLowerCase().includes(q);
    });
  ...
  const deleteMessage = (website) => {
    const ploiNote = website.domain ? ` This will also remove the domain alias "${website.domain}" from the Ploi site (the SSL certificate is left alone to avoid breaking other domains).` : "";
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative flex-1", children: [
          /* @__PURE__ */ jsx("svg", { className: "absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#94a3b8]", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" }) }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "search",
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-lg border border-[#e2e8f0]", children: /* @__PURE__ */ jsx("div", { className: "overflow-visible", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-[#e2e8f0]", children: [
        ...
        /* @__PURE__ */ jsx("tbody", { className: "bg-white divide-y divide-[#e2e8f0]", children: filteredWebsites.length > 0 ? filteredWebsites.map((website) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-[#f8fafc] transition-colors", children: [
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-[#0f172a] group-hover:text-[#3b82f6] transition-colors", children: website.name }),
          ...
          /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-[#64748b]", children: [
            ...
            " ",
            (website.pages?.length ?? 0) === 1 ? "page" : "pages"
          ] }),
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap text-right", children: /* @__PURE__ */ jsxs("div", { className: "relative inline-block text-left", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: "currentColor", viewBox: "0 0 20 20", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { d: "M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z" }) })
              }
            ),
            openDropdownId === website.id && /* @__PURE__ */ jsxs(Fragment, { children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute right-0 z-50 mt-2 w-56 bg-white border border-[#e2e8f0] rounded-lg shadow-lg", children: /* @__PURE__ */ jsxs("div", { className: "py-1", children: [
                ...
                website.is_default && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx("div", { className: "border-t border-[#e2e8f0] my-1" }),
                  /* @__PURE__ */ jsx("p", { className: "px-4 py-2 text-xs text-[#94a3b8]", children: "The default website cannot be deleted." })
                ] }),
                !website.is_default && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx("div", { className: "border-t border-[#e2e8f0] my-1" }),
                  /* @__PURE__ */ jsxs(
          ...
          totalWebsites > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-medium text-[#0f172a]", children: "No websites match your search" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-[#94a3b8] mt-1 mb-4", children: "Try a different search term or status filter" }),
            /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
