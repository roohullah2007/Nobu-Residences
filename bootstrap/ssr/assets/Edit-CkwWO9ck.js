  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-white shadow rounded-lg border border-gray-200 mb-6", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-5 sm:p-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500", children: [
              "Custom domains run through Cloudflare: saving a domain registers it automatically, and SSL activates as soon as the customer points ONE CNAME record at",
              " ",
              /* @__PURE__ */ jsx("code", { className: "font-mono font-semibold text-gray-700", children: cnameTarget || "the CNAME target" }),
              "."
            ] })
          ] })
        ] }),
        website?.domain ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-3 p-4 bg-gray-50 rounded-lg", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "text-xs text-gray-500 mt-1", children: [
              ...
              website.cloudflare_status === "active" ? " - LIVE" : " - waiting for the CNAME (checked automatically every 5 minutes)"
            ] })
          ] }),
          /* @__PURE__ */ jsxs(
            Link,
        ...
        ] }) : /* @__PURE__ */ jsx("div", { className: "p-4 bg-yellow-50 border border-yellow-200 rounded-lg text-sm text-yellow-900", children: "No custom domain set on this website yet. Add one in the Basic Information section below and save — it is registered on Cloudflare automatically." })
      ] }) }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-white shadow rounded-lg border border-gray-200", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-5 sm:p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center mb-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "ml-3", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-lg font-medium text-gray-900", children: "Linked Building" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "The building whose data powers this website" })
            ] })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { htmlFor: "homepage_building_id", className: "block text-sm font-medium text-gray-700 mb-1", children: "Building" }),
            /* @__PURE__ */ jsxs(
              "select",
              {
            ...
            /* @__PURE__ */ jsxs("p", { className: "mt-2 text-sm text-gray-500", children: [
              ...
              String(data.homepage_building_id || "") !== String(website?.homepage_building_id || "") && /* @__PURE__ */ jsx("span", { className: "block mt-1 font-medium text-amber-600", children: "Saving will rebuild the homepage content (hero, key facts, FAQ, footer) from the selected building's data, replacing any manual homepage edits." })
            ] })
          ] }) })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "bg-white shadow rounded-lg border border-gray-200", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-5 sm:p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "sticky bottom-0 z-10 flex items-center justify-end space-x-4 border-t border-gray-200 bg-white/95 backdrop-blur px-4 py-3 sm:rounded-t-lg", children: [
          /* @__PURE__ */ jsx(
            Link,
            {
              href: route("admin.websites.show", website.id),
