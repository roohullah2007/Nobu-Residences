...
const Footer = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("footer", { style: { backgroundColor: footerBg, color: footerText }, children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "py-8 md:py-12 border-t", style: { borderColor: `${footerText}20` }, children: /* @__PURE__ */ jsxs("div", { className: "mx-auto px-4 md:px-0 max-w-[1280px]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row justify-between items-start gap-8 md:gap-4", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "mt-8 md:mt-12 pt-6 md:pt-8 border-t", style: { borderColor: `${footerText}20` }, children: /* @__PURE__ */ jsx("p", { className: "font-work-sans font-normal text-sm leading-6 tracking-[-0.03em] text-center", style: { color: footerText }, children: footerContent.copyright_text }) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx(
      ContactAgentModal,
