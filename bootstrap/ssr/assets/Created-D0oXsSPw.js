  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Website Created", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm sm:rounded-lg p-6", children: [
        ...
        liveStatus?.ai && /* @__PURE__ */ jsx(
          Row,
          {
            icon: /* @__PURE__ */ jsx("svg", { className: "h-5 w-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", d: "M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" }) }),
            title: "AI content (SEO + homepage copy)",
            status: liveStatus.ai.ok,
            message: liveStatus.ai.message
          }
        ),
        aiPending && pollCount >= 4 && /* @__PURE__ */ jsx("div", { className: "mt-3 text-xs p-3 bg-amber-50 border border-amber-200 rounded text-amber-800", children: 'AI content is still pending — the generation run may have been interrupted. Click "Run AI generation now" below to run it again. The site is already live with the template content meanwhile.' }),
        (website.ai_content_status === "failed" || aiPending && pollCount >= 2) && /* @__PURE__ */ jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
            ...
            children: retryingAi ? "Generating..." : website.ai_content_status === "failed" ? "Regenerate AI content" : "Run AI generation now"
          }
        ) }),
        (website.domain || website.ai_content_status === "failed" || aiPending) && /* @__PURE__ */ jsxs("div", { className: "mt-4 flex flex-wrap items-center gap-3", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm sm:rounded-lg p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-5 flex flex-wrap gap-3", children: [
          ...
          /* @__PURE__ */ jsx(
            "a",
            {
              href: website.domain && isLive ? `https://${website.domain}` : `/?website=${website.slug}`,
              target: "_blank",
