...
import { u as useGooglePlacesAutocomplete, Q as QuickCreateSelect, a as QuickCreateInline, D as DeveloperModal } from "./useGooglePlacesAutocomplete-BUvYAfeK.js";
import { D as DeveloperApiSearch, m as matchDeveloperByBuildingName, i as importDeveloperFromApi } from "./DeveloperApiSearch-zr1KR7cX.js";
    ...
    try {
      ...
      setData((prev) => {
        ...
        const fill = (key, value) => {
          if (value !== null && value !== void 0 && value !== "" && !String(next[key] ?? "").trim()) {
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "mt-6 space-y-6 [&_input]:!bg-white [&_input]:!text-gray-900 [&_input]:!border-gray-300 [&_textarea]:!bg-white [&_textarea]:!text-gray-900 [&_textarea]:!border-gray-300 [&_select]:!bg-white [&_select]:!text-gray-900 [&_select]:!border-gray-300 [&_input]:!py-2 [&_input]:!text-sm [&_select]:!py-2 [&_select]:!text-sm [&_textarea]:!text-sm", children: [
        /* @__PURE__ */ jsx("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:p-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-3", children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "development_status", value: "Construction Stage" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500", children: "Construction phase only — whether the building is published is controlled by Visibility Status under Status & Settings." }),
              /* @__PURE__ */ jsx(InputError, { message: errors.development_status, className: "mt-2" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-4", children: [
              ...
              mlsFactsNotice && /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-green-700", children: mlsFactsNotice }),
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:p-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500", children: "Leave blank to auto-fill from live MLS listings for this address after saving." }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "mt-2", children: /* @__PURE__ */ jsx(DeveloperApiSearch, { onSelect: handleApiDeveloperSelect }) }),
              developerApiMessage && /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-green-600", children: developerApiMessage }),
              developerApiError && /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-red-600", children: developerApiError })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-3", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500", children: "Leave blank to auto-fill from MLS when listings publish a monthly parking cost." }),
              /* @__PURE__ */ jsx(InputError, { message: errors.parking_maintenance_fee, className: "mt-2" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-3", children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "sqft_range", value: "Unit Size Range (sqft)" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
                  id: "sqft_range",
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500", children: "Imported from CSV / refreshed from live MLS listings when left blank." }),
              /* @__PURE__ */ jsx(InputError, { message: errors.sqft_range, className: "mt-2" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-3", children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "avg_price_per_sqft", value: "Avg Price Per Sqft" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
              ...
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500", children: "Imported from CSV / refreshed from live MLS listings when left blank." }),
              /* @__PURE__ */ jsx(InputError, { message: errors.avg_price_per_sqft, className: "mt-2" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-3", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:p-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("h2", { className: "text-base font-semibold leading-7 text-gray-900", children: "Description" }),
            /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500", children: "Fill in the building details above first — the AI uses them to write an SEO-optimized description." }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              id: "description",
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:p-8", children: [
          ...
          imageUploadError && /* @__PURE__ */ jsx("div", { className: "mb-4 rounded-md bg-red-50 border border-red-200 px-4 py-3 text-sm text-red-700", children: imageUploadError }),
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:p-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-3", children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "status", value: "Visibility Status" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  id: "status",
