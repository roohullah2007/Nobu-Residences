...
function AdminLayout({ children, title = "Admin" }) {
  ...
  const navigation = [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" }) }),
    ...
    },
    {
      ...
      current: url?.startsWith("/admin/faqs") || false
    },
    {
      name: "Saved Searches",
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" }) }),
                "View Site"
              ]
            }
          ),
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3 pl-3 border-l border-[#e2e8f0]", children: /* @__PURE__ */ jsxs(
            Link,
            {
              href: route("profile.edit"),
              className: "flex items-center gap-2 text-sm text-[#64748b] hover:text-[#0f172a]",
              children: [
                /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-full bg-[#0f172a] flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-white", children: auth?.user?.name?.charAt(0)?.toUpperCase() || "U" }) }),
