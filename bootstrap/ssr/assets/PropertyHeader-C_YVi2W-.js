  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "bg-white", children: /* @__PURE__ */ jsx("div", { className: `max-w-[1280px] mx-auto md:px-0 ${type === "building" ? "pt-8" : ""}`, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse md:flex-row justify-between items-start gap-5", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex-1 pr-5", children: [
        /* @__PURE__ */ jsx("h1", { className: "font-space-grotesk font-bold text-[40px] leading-[50px] text-[#293056] tracking-tight mb-3 md:mb-0", children: getTitle() }),
        (() => {
          ...
          return /* @__PURE__ */ jsx("h2", { className: "font-work-sans text-lg text-[#293056] mb-2", children: /* @__PURE__ */ jsxs("span", { children: [
