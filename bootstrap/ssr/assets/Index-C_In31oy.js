  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Settings", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `space-y-6 ${lightFormClass}`, children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm sm:rounded-lg p-6", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mt-1", children: "Configure general site info, API integrations, and email notifications." })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm sm:rounded-lg overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
          ...
          tab === "api" && /* @__PURE__ */ jsx(ApiKeysTab, { schema: schema.api, values: values.api }),
...
function ApiKeysTab({ schema, values }) {
  ...
  return /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
    /* @__PURE__ */ jsx("div", { className: "space-y-6", children: schema.map((f) => {
      ...
      return /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsx(InputLabel, { htmlFor: f.key, value: labelFor(f.key) }),
          isSensitive && hasValue && /* @__PURE__ */ jsxs("span", { className: "text-xs text-gray-500 font-mono", children: [
            "Current: ",
            masked
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsx(InputError, { message: errors[f.key], className: "mt-2" }),
        isSensitive && /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-gray-500", children: "Leave blank to keep the current value. New values are encrypted at rest." })
      ] }, f.key);
    }) }),
    /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx(PrimaryButton, { disabled: processing, children: processing ? "Saving…" : "Save API settings" }) })
  ] });
}
