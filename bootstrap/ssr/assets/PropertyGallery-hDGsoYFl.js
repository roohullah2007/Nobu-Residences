...
function PropertyGallery({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "max-w-[1280px] mx-auto px-0 py-0", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row gap-0 lg:gap-[17px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex gap-0 md:gap-[17px] flex-1 order-1 lg:order-none relative", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "hidden md:flex lg:flex justify-between flex-col w-full md:w-[318px] h-auto md:h-[645px] gap-2 md:gap-0", children: [
          /* @__PURE__ */ jsx("div", { className: "relative w-full md:w-[318px] h-[200px] md:h-[310px]", children: images.length > 0 ? /* @__PURE__ */ jsxs(
            "div",
            {
              className: "relative w-full h-full rounded-xl overflow-hidden cursor-pointer group",
      ...
      /* @__PURE__ */ jsx("div", { className: "w-full lg:w-[309px] h-auto lg:h-[645px] bg-white border border-gray-200 rounded-xl flex-shrink-0 order-2 lg:order-none mt-[70px] md:mt-5 lg:mt-0", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-between p-4 md:p-6 h-full min-h-[500px] lg:min-h-0", children: [
