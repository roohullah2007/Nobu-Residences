...
const IDXAmpreSearchBar = ({ initialValues = {}, onSearch, onSaveSearch, onFilterClick, isAuthenticated = false, viewMode: externalViewMode, onViewModeChange, autoSearch = false }) => {
  ...
  const handleSearch = () => {
    ...
    if (onSearch) {
      ...
      if (searchData.maxPrice < 1e7) params.append("max_price", searchData.maxPrice);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "bg-gray-100 rounded-2xl px-4 py-3 overflow-visible", style: { fontFamily: "'Helvetica', 'Arial', sans-serif" }, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 w-full flex-wrap lg:flex-nowrap min-w-fit", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 w-full flex-wrap lg:flex-nowrap overflow-visible", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center bg-white rounded-lg px-2 w-full lg:w-[400px] h-[48px] relative", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative w-[103px]", children: [
          /* @__PURE__ */ jsxs(
            "select",
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative w-[135px]", children: [
          /* @__PURE__ */ jsxs(
            "select",
            {
              className: "appearance-none px-3 pr-8 bg-white rounded-lg transition-all cursor-pointer text-[#293056] font-bold text-sm whitespace-nowrap border-0 focus:ring-2 focus:ring-black h-[40px] w-full",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex w-full lg:w-[286px] flex-col gap-2 items-center", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 w-full lg:w-auto flex-wrap lg:flex-nowrap", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            onClick: () => {
