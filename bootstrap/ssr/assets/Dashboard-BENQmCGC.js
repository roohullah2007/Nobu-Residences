...
function Dashboard({ title, stats, websites }) {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" }) })
    },
    {
      name: "Blog Post",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg border border-[#e2e8f0] mt-4", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "p-5", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-[#16a34a] mt-2" }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm text-[#0f172a]", children: "MLS sync completed" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-[#64748b] mt-0.5", children: "4 hours ago" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
