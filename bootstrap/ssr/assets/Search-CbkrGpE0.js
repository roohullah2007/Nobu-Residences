...
import LazyPropertyCard from "./LazyPropertyCard-DqSmzLtr.js";
import ViewportAwarePropertyMap from "./ViewportAwarePropertyMap-C_QmAwuf.js";
import ClusteredPropertyMap from "./ClusteredPropertyMap-BKplqq5L.js";
import { a as createSEOBuildingUrl } from "./slug-BdTdDGUL.js";
import IDXAmpreSearchBar from "./IDXAmpreSearchBar-DH9PJfvB.js";
import FiltersModal from "./FiltersModal-DSeD_PdT.js";
...
function EnhancedPropertySearch({
  ...
  const fetchBuildingCounts = async (buildingList) => {
    const ids = (buildingList || []).map((b) => b.id).filter(Boolean);
    ...
    try {
      ...
      setBuildings(
        (prev) => prev.map(
          (b) => counts[b.id] ? { ...b, units_for_sale: counts[b.id].sale, units_for_rent: counts[b.id].rent } : b
        )
      );
    } catch (error) {
  ...
  const generateDefaultSearchName = () => {
    ...
    if (searchFilters.price_min || searchFilters.price_max && searchFilters.price_max < 1e7) {
      parts.push(`$${(searchFilters.price_min || 0).toLocaleString()}-$${(searchFilters.price_max || 1e7).toLocaleString()}`);
    }
    return parts.length > 0 ? parts.join(", ") : `Search - ${(/* @__PURE__ */ new Date()).toLocaleDateString()}`;
  };
  ...
  const formatBuildingForCard = (building) => {
    ...
    return {
      ...
      developer: (building.developer && typeof building.developer === "object" ? building.developer.name : building.developer) || building.developer_name || null,
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { siteName, siteUrl, year, website, auth, noPadding: true, blueHeader: true, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "enhanced-property-search", children: [
                ...
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("span", { className: "hidden sm:inline", children: "Get alerts" })
                    ]
                  }
                ),
          ...
          isLoading ? (
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col md:border-r border-gray-200", children: [
                    ...
                    /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto p-2 md:p-4 mixed-view-scroll", children: isLoading ? (
                      ...
                      /* @__PURE__ */ jsx("div", { className: "idx-ampre-mixed-grid", style: { alignItems: "stretch" }, children: buildings.map((building) => {
                        ...
                        return /* @__PURE__ */ jsx(
                          PropertyCardV5,
                          {
                            ...
                            className: `w-full h-full transition-all duration-300 ${activeProperty === building.id ? "scale-[1.02] z-10" : ""}`
                          },
                          building.id
                        );
                      }) })
            ...
            /* @__PURE__ */ jsx("div", { children: activeTab === "listings" ? (
              ...
              buildings && buildings.length > 0 ? (
                // alignItems: stretch (overrides the grid's align-items: start)
                // + h-full on the cards = equal-height building cards
                /* @__PURE__ */ jsx("div", { className: "idx-ampre-grid", style: { alignItems: "stretch" }, children: buildings.map((building) => {
                  const formattedBuilding = formatBuildingForCard(building);
                  return /* @__PURE__ */ jsx(
                    PropertyCardV5,
                    {
