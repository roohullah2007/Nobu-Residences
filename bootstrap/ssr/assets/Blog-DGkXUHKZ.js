...
import BlogCategoriesSection from "./BlogCategoriesSection-skcknM6O.js";
...
function Blog({ auth, siteName = "NobuResidence", siteUrl, year, website, blogs, categories: backendCategories, selectedCategory: selectedCategorySlug, faqs = [] }) {
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { auth, website, children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "bg-gray-100 py-8", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 md:px-0 text-center", children: [
      ...
      /* @__PURE__ */ jsxs("form", { className: "max-w-md mx-auto flex gap-4", onSubmit: handleSubscribe, children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "email",
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: subStatus === "loading" ? "Subscribing..." : "Subscribe"
          }
        )
      ] }),
      subMessage && /* @__PURE__ */ jsx("p", { className: `mt-3 text-sm ${subStatus === "success" ? "text-green-600" : "text-red-600"}`, children: subMessage })
    ] }) }),
