...
function LockedCard({ building, isRental, onRegister }) {
  ...
  return /* @__PURE__ */ jsx("div", { "data-card": true, className: "flex-shrink-0 w-[320px] sm:w-[360px] md:w-[380px] snap-start", children: /* @__PURE__ */ jsxs(
    "div",
    {
      onClick: onRegister,
...
function ListingCarousel({
  ...
  return /* @__PURE__ */ jsxs("section", { id, className: "py-14 md:py-20 bg-white", children: [
    /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 md:px-0", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-8", children: [
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: items.map((item) => item.type === "real" ? /* @__PURE__ */ jsx(RealListingCard, { listing: item.listing }, item.key) : /* @__PURE__ */ jsx(LockedCard, { building, isRental: isRentalSection, onRegister: () => setRegisterOpen(true) }, item.key))
      }
    ),
    /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 md:px-0 mt-6 text-right", children: /* @__PURE__ */ jsxs(
      Link,
      {
        href: viewMoreHref,
