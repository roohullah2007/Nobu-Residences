  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Website Created", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm sm:rounded-lg p-6", children: [
        ...
        aiPending && pollCount >= 4 && /* @__PURE__ */ jsxs("div", { className: "mt-3 text-xs p-3 bg-amber-50 border border-amber-200 rounded text-amber-800", children: [
          "AI content is still pending — make sure the queue worker is running:",
          " ",
          /* @__PURE__ */ jsx("code", { className: "font-mono", children: "php artisan queue:work" }),
