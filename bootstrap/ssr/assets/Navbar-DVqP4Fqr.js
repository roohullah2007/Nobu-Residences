...
function Navbar({ auth = {}, website = {}, simplified = false, onDarkBg = false }) {
  ...
  const mobileContainerClass = onDarkBg ? "flex md:hidden justify-between items-center w-full" : "flex md:hidden justify-between items-center px-4 py-3 bg-white rounded-xl w-full";
  ...
  const headerClass = onDarkBg ? "w-full h-full flex items-center justify-center z-20" : "absolute top-0 left-0 right-0 w-full h-[85px] md:h-auto flex items-center justify-center z-20";
  const innerWrapperClass = onDarkBg ? "mx-auto px-4 sm:px-6 md:px-0 w-full max-w-[1280px] h-full flex items-center" : "mx-auto px-3 w-full max-w-[1280px] sm:px-6 md:px-0 flex items-center justify-center py-0 md:py-8";
  return /* @__PURE__ */ jsxs("header", { className: headerClass, children: [
    /* @__PURE__ */ jsxs("div", { className: innerWrapperClass, children: [
      /* @__PURE__ */ jsxs("div", { className: mobileContainerClass, children: [
        ...
        ) : /* @__PURE__ */ jsx("div", { className: "font-space-grotesk font-bold text-sm text-gray-900", children: website?.name || "X HOUSES" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: `hidden md:flex items-center justify-between w-full ${onDarkBg ? "h-full" : "px-6 h-16 bg-white rounded-xl"}`, children: [
        /* @__PURE__ */ jsx(Link, { href: buildUrl("/"), className: "flex items-center cursor-pointer", children: website?.logo_url ? /* @__PURE__ */ jsx(
          "img",
          {
            src: website.logo_url,
        ...
        /* @__PURE__ */ jsxs("nav", { className: "hidden md:flex items-center gap-8", children: [
          ...
          simplified ? /* @__PURE__ */ jsx(
            ...
            /* @__PURE__ */ jsx(Dropdown.Trigger, { children: /* @__PURE__ */ jsxs("button", { className: "flex items-center gap-2 px-4 py-2 rounded-lg transition-colors font-work-sans hover:opacity-80", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: `text-base font-medium ${linkTextClass}`, children: auth.user.name || "User" }),
    ...
    mobileMenuOpen && /* @__PURE__ */ jsxs("div", { className: "md:hidden fixed inset-0 z-[200]", children: [
      /* @__PURE__ */ jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "relative h-full flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-h-[90vh] flex flex-col bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden animate-in fade-in zoom-in-95 duration-200", children: [
