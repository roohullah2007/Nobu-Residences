...
import BuildingTourScheduling from "./BuildingTourScheduling-F9JVUjXi.js";
import RealEstateLinksSection from "./RealEstateLinksSection-rgnwZUht.js";
import BuildingGallery from "./BuildingGallery-DclMY-kI.js";
import BuildingSections from "./BuildingSections-C2YxCO0A.js";
...
function BuildingDetail({ auth, siteName, siteUrl, year, buildingId, buildingData, website, faqs = [] }) {
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { siteName, siteUrl, year, website, auth, blueHeader: true, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "idx mx-auto overflow-hidden bg-primary pb-24 md:pb-0", children: /* @__PURE__ */ jsxs("div", { className: "px-4 xl:px-0 max-w-[1280px] mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-6 w-full", children: [
        /* @__PURE__ */ jsxs("div", { className: "w-full min-w-0 lg:flex-1 xl:flex-none xl:w-[950px]", children: [
          /* @__PURE__ */ jsx(
            BuildingSections,
            {
              buildingData: effectiveBuildingData,
        ...
        /* @__PURE__ */ jsx("div", { className: `hidden md:flex w-full max-w-[309px] flex-shrink-0 transition-opacity duration-300 ${sidebarVisible ? "opacity-100" : "opacity-0 pointer-events-none"}`, children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
