...
import LoginModal from "./LoginModal-CkvRiYR7.js";
...
const formatPrice = (n) => {
  if (n === null || n === void 0 || n === "" || Number.isNaN(Number(n))) return null;
...
function CompareListings({
  ...
  const readKeys = useCallback(() => {
    try {
      ...
      if (Array.isArray(stored) && stored.length > 0) {
        return stored.map((item) => item.listingKey || item.property_listing_key || item?.property_data?.listingKey).filter(Boolean);
      }
    } catch (_) {
    }
  ...
  const hydrate = useCallback(async (keys) => {
    ...
    try {
      ...
      const ordered = keys.map((k) => items2.find((it) => it.listingKey === k)).filter(Boolean);
      setHydrated(ordered);
    } catch (error) {
  ...
  const saveAllToFavourites = async () => {
    ...
    try {
      ...
      setSavedAll(true);
      setTimeout(() => setSavedAll(false), 3e3);
    } catch (error) {
  ...
  const handleShare = async () => {
    ...
    try {
      if (navigator.share && navigator.canShare && navigator.canShare(shareData)) {
        ...
        setTimeout(() => setShowShareSuccess(false), 3e3);
      }
    } catch (error) {
  ...
  const buildingRows = [
    ...
    },
    {
      ...
      get: (it) => {
        ...
        if (!yb) return dash;
        const age = (/* @__PURE__ */ new Date()).getFullYear() - yb;
        return `${age} Years`;
      }
    },
  ...
  const renderCellContent = (val) => {
    if (val == null) return /* @__PURE__ */ jsx("span", { className: "text-gray-400", children: dash });
    if (typeof val === "object") {
      if (val.isLink) {
        return /* @__PURE__ */ jsx("a", { href: val.href, className: "text-[#037888] underline truncate", title: val.value, children: val.value });
      }
      if (val.isAction) {
        return /* @__PURE__ */ jsx(
          "button",
  ...
  const ComparisonGrid = ({ rows, sectionTitle }) => /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-200 p-4 sm:p-6 mb-4", children: [
    sectionTitle && /* @__PURE__ */ jsx("h2", { className: "font-space-grotesk font-bold text-[#293056] text-xl sm:text-2xl mb-4 sm:mb-6", children: sectionTitle }),
    /* @__PURE__ */ jsx("div", { className: "divide-y divide-dashed divide-gray-200", children: rows.map((row) => /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-2 lg:gap-4 py-3 items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "font-work-sans text-[#293056] text-sm lg:text-base", children: row.label }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-2 sm:gap-3", children: slots.map((it, idx) => /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: it ? renderCellContent(row.get(it)) : /* @__PURE__ */ jsx("span", { className: "text-gray-400", children: dash })
        },
        idx
      )) })
    ] }, row.label)) })
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { auth, website, blueHeader: true, children: [
    /* @__PURE__ */ jsx(Head, { title: "Compare Listings" }),
    /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-white", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1280px] mx-auto px-4 py-6 sm:py-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row justify-between items-start gap-4 mb-6 sm:mb-8", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "font-space-grotesk font-bold text-[#293056] mb-2 text-[28px] sm:text-[36px] md:text-[40px]", children: "Compare Listings" }),
          hasItems ? /* @__PURE__ */ jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsx("svg", { className: `w-5 h-5 ${savedAll ? "text-red-500 fill-red-500" : "text-[#037888]"}`, fill: savedAll ? "currentColor" : "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4.318 6.318a4.5 4.5 0 016.364 0L12 7.636l1.318-1.318a4.5 4.5 0 116.364 6.364L12 20.364l-7.682-7.682a4.5 4.5 0 010-6.364z" }) }),
                /* @__PURE__ */ jsx("span", { className: "text-[#037888] underline", children: savedAll ? "Saved!" : "Save all listings" }),
                /* @__PURE__ */ jsx("span", { className: "text-gray-600", children: "to your favourites to compare later." })
              ]
            }
          ) : /* @__PURE__ */ jsx("p", { className: "font-work-sans text-gray-600 text-base sm:text-lg", children: "Add properties to compare by clicking the compare button on any property card." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2 sm:gap-3 w-full sm:w-auto", children: [
          ...
          /* @__PURE__ */ jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M16 8l-4-4-4 4M12 4v12" }) }),
                "Share"
              ]
            }
          )
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-4 sm:gap-6 items-start mb-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-200 p-4 sm:p-6 flex-shrink-0 shadow-sm w-full lg:w-[300px]", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-row lg:flex-col items-center gap-4 lg:gap-0", children: [
            /* @__PURE__ */ jsx("div", { className: "w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-full overflow-hidden border-4 border-gray-100 lg:mb-4 flex-shrink-0", children: agentImage ? /* @__PURE__ */ jsx("img", { src: agentImage, alt: agentName, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx("div", { className: "w-full h-full bg-gray-300 flex items-center justify-center", children: /* @__PURE__ */ jsx("span", { className: "text-xl sm:text-2xl lg:text-3xl font-bold text-gray-500", children: agentName ? agentName.charAt(0) : "?" }) }) }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 lg:flex-none lg:text-center", children: [
              agentTitle && /* @__PURE__ */ jsx("p", { className: "font-work-sans text-gray-500 text-xs sm:text-sm lg:text-center", children: agentTitle }),
              agentName && /* @__PURE__ */ jsx("h3", { className: "font-work-sans font-bold text-[#101323] text-base sm:text-lg lg:text-center mt-1", children: agentName }),
              agentPhone && /* @__PURE__ */ jsx("a", { href: `tel:${agentPhone}`, className: "block font-work-sans text-[#037888] underline text-sm mt-2 lg:text-center", children: agentPhone })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
        ...
        /* @__PURE__ */ jsx("div", { className: "flex-1 w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4", children: slots.map((it, idx) => /* @__PURE__ */ jsx("div", { className: "relative", children: it ? /* @__PURE__ */ jsxs("div", { className: "bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ jsx("svg", { className: "w-3.5 h-3.5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) })
            }
          ),
          /* @__PURE__ */ jsxs("a", { href: propertyHref(it), className: "block relative", children: [
            /* @__PURE__ */ jsxs("span", { className: "absolute top-2 left-2 z-10 inline-flex items-center gap-1 bg-[#293056] text-white text-xs font-semibold px-2 py-1 rounded", children: [
              /* @__PURE__ */ jsx("svg", { className: "w-3 h-3 text-yellow-300", fill: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { d: "M12 .587l3.668 7.568L24 9.75l-6 5.847L19.336 24 12 19.897 4.664 24 6 15.597 0 9.75l8.332-1.595z" }) }),
              "Featured"
            ] }),
            it.imageUrl ? /* @__PURE__ */ jsx("img", { src: it.imageUrl, alt: it.shortAddress, className: "w-full h-[160px] object-cover" }) : /* @__PURE__ */ jsx("div", { className: "w-full h-[160px] bg-gray-200 flex items-center justify-center text-gray-400 text-xs", children: "No image" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "p-3", children: [
            /* @__PURE__ */ jsx("div", { className: "font-work-sans font-bold text-[#293056] text-base", children: formatPrice(it.listPrice) || dash }),
            /* @__PURE__ */ jsx("a", { href: propertyHref(it), className: "block font-work-sans text-[#037888] underline text-sm mt-1 truncate", children: it.shortAddress || it.listingKey })
          ] })
        ] }) : /* @__PURE__ */ jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("svg", { className: "w-10 h-10 text-gray-400 mb-2", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M12 4v16m8-8H4" }) }),
              /* @__PURE__ */ jsx("span", { className: "text-sm font-medium", children: "Add a property" })
            ]
          }
        ) }, idx)) })
      ] }),
      isHydrating && hasItems === false && /* @__PURE__ */ jsx("div", { className: "text-center text-gray-500 py-8", children: "Loading comparison details…" }),
      !isHydrating && !hasItems && /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center h-[250px] sm:h-[352px] bg-gray-50 rounded-2xl border-2 border-dashed border-gray-300 px-4", children: [
        /* @__PURE__ */ jsx("svg", { className: "w-12 h-12 sm:w-16 sm:h-16 text-gray-400 mb-3 sm:mb-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" }) }),
        /* @__PURE__ */ jsx("h3", { className: "font-work-sans font-semibold text-gray-700 text-base sm:text-lg mb-2 text-center", children: "No properties to compare" }),
        /* @__PURE__ */ jsx("p", { className: "font-work-sans text-gray-500 text-center text-sm sm:text-base max-w-sm", children: "Add properties to compare by clicking the compare button on any property card." }),
        /* @__PURE__ */ jsx(
          "a",
          {
            href: "/search",
      ...
      hasItems && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(ComparisonGrid, { sectionTitle: "Properties detail", rows: propertyRows }),
        /* @__PURE__ */ jsx(ComparisonGrid, { sectionTitle: "Includes", rows: includesRows }),
        /* @__PURE__ */ jsx(ComparisonGrid, { sectionTitle: "Building", rows: buildingRows }),
        /* @__PURE__ */ jsx(ComparisonGrid, { sectionTitle: "Neighbourhood", rows: neighbourhoodRows }),
        /* @__PURE__ */ jsx("div", { className: "flex justify-center mb-8", children: /* @__PURE__ */ jsx(
          "a",
          {
            ...
            children: "See what's around"
          }
        ) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mt-8 sm:mt-12 -mx-4 sm:mx-0", children: /* @__PURE__ */ jsx(
        FAQ,
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-8 sm:mt-12 -mx-4 sm:mx-0", children: /* @__PURE__ */ jsx(RealEstateLinksSection, {}) })
    ] }) }),
    /* @__PURE__ */ jsx(
      ContactAgentModal,
      {
    ...
    showShareSuccess && /* @__PURE__ */ jsx("div", { className: "fixed bottom-4 left-1/2 -translate-x-1/2 z-[1000000] animate-fade-in", children: /* @__PURE__ */ jsxs("div", { className: "bg-[#293056] text-white px-6 py-3 rounded-full shadow-lg flex items-center gap-2", children: [
      /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 text-green-400", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) }),
      /* @__PURE__ */ jsx("span", { className: "font-work-sans font-medium text-sm", children: "Link copied to clipboard!" })
    ] }) })
  ] });
}
export {
  CompareListings as default
};
