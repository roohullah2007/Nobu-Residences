...
const LoginModal = ({ isOpen, onClose, website = {}, initialTab = "register" }) => {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl max-w-md w-full mx-4 relative shadow-2xl", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            onClick: onClose,
        ...
        /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-6", children: [
            /* @__PURE__ */ jsx("h2", { className: "text-2xl font-space-grotesk font-bold mb-2", style: { color: brandColors.primary }, children: showForgotPassword ? "Reset Password" : `Welcome to ${siteDisplayName}` }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-sm", children: showForgotPassword ? "Enter your email address and we'll send you a link to reset your password" : activeTab === "login" ? "Sign in to access your account and saved properties" : "Create an account to save properties and get personalized recommendations" })
          ] }),
          !showForgotPassword && /* @__PURE__ */ jsxs("div", { className: "flex mb-6 bg-gray-100 rounded-lg p-1", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => setActiveTab("login"),
                className: `flex-1 py-2 px-4 text-sm font-medium rounded-md transition-colors ${activeTab === "login" ? "bg-white shadow-sm" : "text-gray-500 hover:text-gray-700"}`,
                children: "Sign In"
              }
            ),
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                className: `flex-1 py-2 px-4 text-sm font-medium rounded-md transition-colors ${activeTab === "register" ? "bg-white shadow-sm" : "text-gray-500 hover:text-gray-700"}`,
