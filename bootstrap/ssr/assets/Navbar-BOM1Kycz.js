...
function Navbar({ auth = {}, website = {}, simplified = false, onDarkBg = false }) {
  ...
  const innerWrapperClass = onDarkBg ? "mx-auto w-full max-w-[1280px] h-full flex items-center" : "mx-auto px-3 w-full max-w-[1280px] sm:px-6 md:px-0 flex items-center justify-center py-0 md:py-8";
