...
function BuildingsCreate({ auth, developers = [], amenities = [], maintenanceFeeAmenities = [], neighbourhoods = [], subNeighbourhoods = [] }) {
  ...
  const filteredSubNeighbourhoods = data.neighbourhood_id ? subNeighbourhoods.filter((sub) => sub.neighbourhood_id === data.neighbourhood_id) : subNeighbourhoods;
              ...
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  children: [
                    ...
                    neighbourhoods.map((neighbourhood) => /* @__PURE__ */ jsx("option", { value: neighbourhood.id, children: neighbourhood.name }, neighbourhood.id))
                  ]
                }
              ),
              ...
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  children: [
                    ...
                    filteredSubNeighbourhoods.map((subNeighbourhood) => /* @__PURE__ */ jsxs("option", { value: subNeighbourhood.id, children: [
