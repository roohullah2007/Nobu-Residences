        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white shadow rounded-lg", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsx("dd", { className: "mt-1 text-sm text-gray-900", children: building.maintenance_fee_range || "N/A" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("dt", { className: "text-sm font-medium text-gray-500", children: "Parking Maintenance" }),
              /* @__PURE__ */ jsx("dd", { className: "mt-1 text-sm text-gray-900", children: building.parking_maintenance_fee ? `$${Number(building.parking_maintenance_fee).toLocaleString()}/month` : "N/A" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("dt", { className: "text-sm font-medium text-gray-500", children: "Locker Maintenance" }),
              /* @__PURE__ */ jsx("dd", { className: "mt-1 text-sm text-gray-900", children: building.locker_maintenance_fee ? `$${Number(building.locker_maintenance_fee).toLocaleString()}/month` : "N/A" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("dt", { className: "text-sm font-medium text-gray-500", children: "Avg Price Per Sqft" }),
              /* @__PURE__ */ jsx("dd", { className: "mt-1 text-sm text-gray-900", children: building.avg_price_per_sqft || "N/A" })
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
