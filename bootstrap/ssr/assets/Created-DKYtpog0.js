...
function WebsiteCreated({ website, report, ploi, liveStatus = null, liveAliases = [], liveCertificates = [], persisted = {}, dnsCheck = null }) {
  ...
  const aliasAlreadyAdded = Boolean(
    website.domain && (liveAliases || []).some((a) => typeof a === "string" && a.toLowerCase() === website.domain.toLowerCase())
  );
      ...
      ploi.configured && /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm sm:rounded-lg p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { className: "border border-gray-200 rounded-lg p-4", children: [
            ...
            liveAliases.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500 italic", children: "No aliases configured." }) : /* @__PURE__ */ jsx("ul", { className: "text-sm space-y-1.5", children: liveAliases.map((a) => {
