...
function BlogEdit() {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Edit Blog Post", children: [
    /* @__PURE__ */ jsx(Head, { title: `Edit: ${blog.title}` }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-6", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "Edit Blog Post" }),
          /* @__PURE__ */ jsxs("div", { className: "mt-1 flex items-center space-x-4 text-sm text-gray-500", children: [
            /* @__PURE__ */ jsxs("span", { children: [
              "Created: ",
              formatDate(blog.created_at)
            ] }),
            blog.published_at && /* @__PURE__ */ jsxs("span", { children: [
              "Published: ",
              formatDate(blog.published_at)
            ] }),
            /* @__PURE__ */ jsxs("span", { children: [
              "Status: ",
              /* @__PURE__ */ jsx("span", { className: `font-medium ${blog.status === "published" ? "text-green-600" : "text-yellow-600"}`, children: blog.status })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex space-x-3", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: processing || isSubmitting ? "Updating..." : "Update & Publish"
            }
          )
        ] })
      ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 border border-gray-200 rounded-lg p-4", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-sm font-medium text-gray-900 mb-3", children: "Post Information" }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-2 text-sm text-gray-600", children: [
                ...
                blog.published_at && /* @__PURE__ */ jsxs("div", { children: [
