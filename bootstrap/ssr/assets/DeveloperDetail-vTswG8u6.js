    ...
    return /* @__PURE__ */ jsxs(MainLayout, { auth, website, children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "pt-8 sm:pt-16 pb-6 sm:pb-8 bg-white", children: /* @__PURE__ */ jsx("div", { className: "max-w-[1280px] mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row justify-between items-start gap-6 sm:gap-8 rounded-2xl p-4 sm:p-8", style: { backgroundColor: "#F8F9FC" }, children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1 w-full lg:w-auto", children: [
          /* @__PURE__ */ jsx("div", { className: "inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-[#912018] text-white text-xs sm:text-sm font-medium mb-4 sm:mb-6", children: "(154 Ratings, Average: 5 out of 5)" }),
          /* @__PURE__ */ jsx(
            "h1",
            {
      ...
      /* @__PURE__ */ jsx("section", { className: "py-12 bg-white", children: /* @__PURE__ */ jsx("div", { className: "max-w-[1280px] mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "rounded-2xl p-4 sm:p-8", style: { backgroundColor: "#F8F9FC" }, children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-8 lg:gap-12", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex-1 lg:max-w-[60%]", children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-8", children: [
              /* @__PURE__ */ jsx(
                "h3",
                {
                  ...
                  children: "90 Years of Excellence"
                }
              ),
              /* @__PURE__ */ jsxs(
                "p",
                {
                  ...
                  children: [
                    developer.name,
                    ", a Canadian homebuilder since 1934, has earned a reputation for excellence in craftsmanship, innovation, and sustainability. Having built over 25,000 green suites, ",
                    developer.name,
                    " is committed to creating communities that conserve more energy and resources than traditional standards. Over its ",
                    /* @__PURE__ */ jsxs("span", { className: "underline font-semibold", children: [
                      "90-year history, ",
                      developer.name,
                      " has built more than 90,000 homes across 200+ communities,"
                    ] }),
                    " leading the new home and condominium market."
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx(
                "h3",
                {
                  className: "font-work-sans font-bold text-[#101323] mb-4",
                  style: { fontSize: "18px", lineHeight: "27px", letterSpacing: "-0.03em" },
                  children: "VIP Access Through Platinum Condo Deals"
                }
              ),
              /* @__PURE__ */ jsxs(
                "p",
                {
                  ...
                  style: { fontSize: "16px", lineHeight: "25px", letterSpacing: "-0.03em" },
                  children: [
                    "Looking for your dream condo or new home? Platinum Condo Deals and ",
                    developer.name,
                    " have joined forces to offer you exclusive access to their best real estate options. Explore thriving neighbourhoods like Bayview Woods and find your perfect match."
                  ]
                }
              )
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex-shrink-0 w-full lg:w-[380px] space-y-4 sm:space-y-6", children: [
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl p-5 flex items-center gap-4", style: { backgroundColor: "#EBECF5" }, children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "font-work-sans font-bold text-[#912018] text-xl", children: "90000" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl p-5 flex items-center gap-4", style: { backgroundColor: "#EBECF5" }, children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "font-work-sans font-bold text-[#912018] text-xl", children: "10" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl p-5 flex items-center gap-4", style: { backgroundColor: "#EBECF5" }, children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "font-work-sans font-bold text-[#912018] text-xl", children: "12" })
            ] })
          ] })
        ] }),
      ...
      buildings.length > 0 && /* @__PURE__ */ jsx("section", { className: "py-8 sm:py-12 bg-white", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1280px] mx-auto px-4", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: buildings.map((building) => {
          const buildingImage = building.main_image ? building.main_image.startsWith("/") ? building.main_image : `/storage/${building.main_image}` : building.images?.[0] || "/images/placeholder-property.jpg";
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex flex-col flex-grow items-start p-4 gap-2.5 box-border", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-start gap-2 w-full", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-start w-full min-h-8 pb-2 border-b border-gray-200 font-work-sans font-normal text-sm leading-6 tracking-tight text-gray-600", children: [
                      ...
                      " ",
                      /* @__PURE__ */ jsx("span", { className: "text-[#293056] font-medium", children: developer?.name || "Developer" })
                    ] }),
      ...
      /* @__PURE__ */ jsx("section", { className: "py-10 sm:py-16 bg-white", children: /* @__PURE__ */ jsx("div", { className: "max-w-[1280px] mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("ul", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              ...
              /* @__PURE__ */ jsxs("p", { className: "font-work-sans text-[#293056]", children: [
                /* @__PURE__ */ jsx("span", { className: "font-bold", children: "Building for the Future:" }),
                " ",
                developer.name,
                " communities offer sustainable, innovative homes with 34% less electricity, 57% less natural gas, and 43% less water consumption than standard buildings."
              ] })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "w-2 h-2 bg-[#293056] rounded-full mt-2 flex-shrink-0" }),
              /* @__PURE__ */ jsxs("p", { className: "font-work-sans text-[#293056]", children: [
                /* @__PURE__ */ jsx("span", { className: "font-bold", children: "A Legacy of Craftsmanship:" }),
                " ",
                developer.name,
                "'s legacy of excellence in homebuilding dates back to 1934, with their expertise evident in every meticulously crafted detail."
              ] })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "w-2 h-2 bg-[#293056] rounded-full mt-2 flex-shrink-0" }),
              /* @__PURE__ */ jsxs("p", { className: "font-work-sans text-[#293056]", children: [
                /* @__PURE__ */ jsx("span", { className: "font-bold", children: "Creating Vibrant Communities:" }),
                " ",
                developer.name,
                " goes beyond building houses; they create thriving neighbourhoods where people can connect and flourish."
              ] })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "w-2 h-2 bg-[#293056] rounded-full mt-2 flex-shrink-0" }),
              /* @__PURE__ */ jsxs("p", { className: "font-work-sans text-[#293056]", children: [
                /* @__PURE__ */ jsx("span", { className: "font-bold", children: "Innovation at the Forefront:" }),
                " ",
                developer.name,
                " stays ahead of the curve by embracing new technologies and sustainable practices to enhance their homes and communities."
              ] })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "w-2 h-2 bg-[#293056] rounded-full mt-2 flex-shrink-0" }),
              /* @__PURE__ */ jsxs("p", { className: "font-work-sans text-[#293056]", children: [
                /* @__PURE__ */ jsx("span", { className: "font-bold", children: "Diversity and Inclusion:" }),
                " ",
                developer.name,
                " believes in the power of diversity and is committed to creating an inclusive workplace and fostering positive change in the communities."
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("ul", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "w-2 h-2 bg-[#293056] rounded-full mt-2 flex-shrink-0" }),
              /* @__PURE__ */ jsxs("p", { className: "font-work-sans text-[#293056]", children: [
                /* @__PURE__ */ jsx("span", { className: "font-bold", children: "Green Builder of the Year, Mid/High-Rise 2024:" }),
                " ",
                developer.name,
                " received a prestigious 2024 BILD Award for its dedication to sustainable development."
              ] })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "w-2 h-2 bg-[#293056] rounded-full mt-2 flex-shrink-0" }),
              /* @__PURE__ */ jsxs("p", { className: "font-work-sans text-[#293056]", children: [
                /* @__PURE__ */ jsx("span", { className: "font-bold", children: "Best High-Rise Building Design 2023:" }),
                " ",
                developer.name,
                "'s Harbourwalk at Lakeview Village was honoured with the ",
                /* @__PURE__ */ jsx("span", { className: "underline", children: "Best High-Rise Building Design" }),
                " award."
              ] })
            ] }),
            /* @__PURE__ */ jsxs("li", { className: "flex items-start gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "w-2 h-2 bg-[#293056] rounded-full mt-2 flex-shrink-0" }),
              /* @__PURE__ */ jsxs("p", { className: "font-work-sans text-[#293056]", children: [
                /* @__PURE__ */ jsx("span", { className: "font-bold", children: "Ontario Builder of the Year 2022:" }),
                " ",
                developer.name,
                " was celebrated as a leader in homebuilding in Ontario, receiving the ",
                /* @__PURE__ */ jsx("span", { className: "underline", children: "Builder of the Year award" }),
                " at the 2022 BILD Awards."
              ] })
            ] })
          ] })
        ] })
      ] }) }) }),
      listings.length > 0 && /* @__PURE__ */ jsx("section", { className: "py-8 sm:py-12 bg-white", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1280px] mx-auto px-4", children: [
        /* @__PURE__ */ jsx("div", { className: "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-2", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2 sm:gap-4", children: [
          /* @__PURE__ */ jsxs("h2", { className: "font-space-grotesk font-bold text-[22px] sm:text-[28px] md:text-[32px] leading-tight tracking-[-0.03em] text-[#293056]", children: [
            "Listings by ",
            developer.name
      ...
      isModalOpen && /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[999999] flex items-center justify-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative bg-white p-6 rounded-lg max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto", children: [
          ...
          /* @__PURE__ */ jsxs("form", { onSubmit: handleTourSubmit, children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsx("label", { className: "block text-gray-700 mb-1 font-medium", children: "Full Name" }),
              /* @__PURE__ */ jsx("input", { type: "text", name: "name", value: formData.name, onChange: handleInputChange, className: "w-full py-2 px-3 border border-gray-300 rounded-lg", required: true })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsx("label", { className: "block text-gray-700 mb-1 font-medium", children: "Email Address" }),
              /* @__PURE__ */ jsx("input", { type: "email", name: "email", value: formData.email, onChange: handleInputChange, className: "w-full py-2 px-3 border border-gray-300 rounded-lg", required: true })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsx("label", { className: "block text-gray-700 mb-1 font-medium", children: "Phone Number" }),
              /* @__PURE__ */ jsx("input", { type: "tel", name: "phone", value: formData.phone, onChange: handleInputChange, className: "w-full py-2 px-3 border border-gray-300 rounded-lg", required: true })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
      ...
      isQuestionModalOpen && /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[999999] flex items-center justify-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative bg-white p-6 rounded-lg max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto", children: [
          ...
          /* @__PURE__ */ jsxs("form", { onSubmit: handleQuestionSubmit, children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsx("label", { className: "block text-gray-700 mb-1 font-medium", children: "Full Name" }),
              /* @__PURE__ */ jsx("input", { type: "text", name: "name", value: questionFormData.name, onChange: handleQuestionInputChange, className: "w-full py-2 px-3 border border-gray-300 rounded-lg", required: true })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsx("label", { className: "block text-gray-700 mb-1 font-medium", children: "Email Address" }),
              /* @__PURE__ */ jsx("input", { type: "email", name: "email", value: questionFormData.email, onChange: handleQuestionInputChange, className: "w-full py-2 px-3 border border-gray-300 rounded-lg", required: true })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsx("label", { className: "block text-gray-700 mb-1 font-medium", children: "Phone Number" }),
              /* @__PURE__ */ jsx("input", { type: "tel", name: "phone", value: questionFormData.phone, onChange: handleQuestionInputChange, className: "w-full py-2 px-3 border border-gray-300 rounded-lg", required: true })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsx("label", { className: "block text-gray-700 mb-1 font-medium", children: "Your Question" }),
              /* @__PURE__ */ jsx("textarea", { name: "question", value: questionFormData.question, onChange: handleQuestionInputChange, className: "w-full py-2 px-3 border border-gray-300 rounded-lg min-h-[100px]", required: true })
            ] }),
      ...
      developer?.description && /* @__PURE__ */ jsx("section", { className: "py-10 sm:py-16 bg-white", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1280px] mx-auto px-4", children: [
        /* @__PURE__ */ jsxs(
          "h2",
          {
