...
function BuildingInfo({ pageContent, building = {} }) {
  ...
  const badgeSubtitle = [building.sub_neighbourhood, building.neighbourhood, building.city].map((v) => v == null ? "" : String(v).trim()).filter(Boolean).join(" · ").toUpperCase() || "LUXURY RESIDENCES";
  const clean = (v) => {
  ...
  return /* @__PURE__ */ jsx("section", { id: "building", className: "bg-white py-16 md:py-24", children: /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-screen-xl px-4 md:px-0", children: /* @__PURE__ */ jsxs("div", { className: "grid items-center gap-12 lg:grid-cols-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "absolute -bottom-5 -left-5 hidden max-w-[240px] rounded-2xl border border-gold-300 bg-white/90 px-6 py-4 backdrop-blur-sm shadow-lg md:block", children: [
        /* @__PURE__ */ jsx("p", { className: "font-playfair text-xl font-semibold leading-tight text-gold-600", children: buildingName }),
        /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs uppercase tracking-[0.2em] text-neutral-500 leading-tight", children: badgeSubtitle })
      ] })
    ] })
  ] }) }) });
}
