...
import "react";
function BuildingAmenities({ buildingData }) {
  ...
  const maintenanceFeeAmenities = buildingData.maintenance_fee_amenities || buildingData.maintenanceFeeAmenities || [];
  console.log("BuildingAmenities: Maintenance Fee Amenities:", maintenanceFeeAmenities);
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row items-start gap-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex-1 w-full lg:max-w-[658px]", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-base font-semibold mb-4", style: { color: "rgb(41, 48, 86)" }, children: "Building Features & Services" }),
      /* @__PURE__ */ jsx("div", { className: "border border-gray-200 rounded-lg p-4 h-full", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-4 lg:gap-x-8 lg:gap-y-4", children: buildingData.amenities.map((amenity, index) => {
    ...
    maintenanceFeeAmenities.length > 0 && /* @__PURE__ */ jsxs("div", { className: "w-full lg:w-[300px] lg:flex-shrink-0", children: [
      /* @__PURE__ */ jsx("h3", { className: "text-base font-semibold mb-4", style: { color: "rgb(41, 48, 86)" }, children: "Included in Maintenance Fees" }),
      /* @__PURE__ */ jsx("div", { className: "border border-gray-200 rounded-lg p-4 h-full", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 lg:grid-cols-1 gap-4", children: maintenanceFeeAmenities.map((amenity, index) => /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center gap-2", children: [
        /* @__PURE__ */ jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsx("img", { src: "/assets/svgs/tick.svg", alt: "Included", className: "w-5 h-5" })
      ] }, amenity.id || index)) }) })
    ] })
  ] });
}
export {
  BuildingAmenities as default
};
