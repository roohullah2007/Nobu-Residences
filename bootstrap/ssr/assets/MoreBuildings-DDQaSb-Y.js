...
const MoreBuildings = ({
  ...
  return /* @__PURE__ */ jsxs("section", { className: `p-3 rounded-xl border-gray-200 border shadow-sm bg-gray-50 ${title === "Nearby Listings" ? "nearby-listings-container" : title === "Similar Listings" ? "similar-listings-container" : ""}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "max-w-[1280px] mx-auto", children: [
      ...
      !isLoading && !isLoadingImages && buildings.length > 0 && !isGridLayout && /* @__PURE__ */ jsx("div", { className: "block md:hidden", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-4", children: buildings.slice(0, 6).map((building) => /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsx(
        PropertyCardV5,
        {
          property: building,
          size: "grid",
