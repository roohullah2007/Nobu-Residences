...
const PropertyCarouselV2 = ({
  ...
  const formatPropertyData = (property) => {
    return {
      ...
      priceRange: property.price ? property.isRental ? `$${property.price.toLocaleString()}/mo` : `$${property.price.toLocaleString()}` : property.priceRange || "Price on request",
  ...
  return /* @__PURE__ */ jsxs("div", { className: `font-work-sans w-full max-w-[1280px] mx-auto clear-both overflow-visible ${showBackground ? "bg-gray-50 p-4 rounded-xl border-gray-200 border shadow-sm" : "my-8"} ${className}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsx("div", { className: "hidden xl:block", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "overflow-hidden w-full max-w-[1140px]", children: [
          " ",
          /* @__PURE__ */ jsx(
            "div",
            {
      ...
      /* @__PURE__ */ jsx("div", { className: "hidden lg:block xl:hidden", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "flex flex-col justify-center items-center p-1 gap-2.5 w-16 h-16 flex-none", children: /* @__PURE__ */ jsx(
          "button",
          {
            onClick: handlePrevious,
