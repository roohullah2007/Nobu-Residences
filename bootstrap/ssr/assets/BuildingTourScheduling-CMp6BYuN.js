      ...
      const response = await fetch("/api/tour-requests", {
        ...
        body: JSON.stringify({
          ...
          property_address: (() => {
            ...
            return buildingData?.full_address || `${buildingData?.address || ""} ${buildingData?.city || ""} ${buildingData?.province || ""}`.trim() || buildingData?.name || "Building Address Not Available";
          })()
        })
      });
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    showSuccess && /* @__PURE__ */ jsx("div", { className: "fixed top-4 right-4 z-[1000000] animate-slide-in-right", children: /* @__PURE__ */ jsxs("div", { className: "bg-green-50 border border-green-200 rounded-lg p-4 flex items-start shadow-lg max-w-sm", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-sm font-medium text-green-800", children: successType === "question" ? "Question Submitted!" : "Building Tour Request Submitted!" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm text-green-700 mt-1", children: successType === "question" ? "We'll get back to you within 24 hours." : "We'll contact you shortly to confirm your building tour." })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "bg-white text-center flex flex-col p-4 items-center justify-center w-full mx-auto shadow-lg rounded-lg border border-gray-300", children: [
                /* @__PURE__ */ jsx("h2", { className: "text-xl font-space-grotesk font-extrabold mb-1", style: { color: "#293056" }, children: "Schedule a building tour" }),
                /* @__PURE__ */ jsx("p", { className: "text-gray-700 text-sm mt-1 mb-2", children: "Visit the building amenities" }),
                ...
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    children: "Request Building Tour"
                  }
                ),
                /* @__PURE__ */ jsx("div", { className: "text-center text-gray-500 my-3", children: /* @__PURE__ */ jsx("p", { children: "OR" }) }),
                /* @__PURE__ */ jsx(
                  "button",
                  {
    ...
    isModalOpen && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[999999] bg-black bg-opacity-50 flex items-center justify-center p-4", onClick: handleModalClick, children: /* @__PURE__ */ jsxs("div", { className: "relative bg-white p-6 rounded-lg max-w-lg w-full max-h-[90vh] overflow-y-auto", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold", style: { color: "#293056" }, children: "Request a Building Tour" }),
        /* @__PURE__ */ jsx(
          "button",
          {
            onClick: closeModal,
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-4 space-y-2", children: [
        ...
        buildingData && /* @__PURE__ */ jsxs("p", { className: "text-gray-600 text-sm", children: [
          "Building: ",
          /* @__PURE__ */ jsx("span", { className: "font-medium", children: (() => {
            if (buildingData?.street_address_1 && buildingData?.street_address_2) {
              return `${buildingData.street_address_1} & ${buildingData.street_address_2} ${buildingData?.city || ""} ${buildingData?.province || ""}`.trim();
            }
            return buildingData?.full_address || `${buildingData?.address || ""} ${buildingData?.city || ""} ${buildingData?.province || ""}`.trim() || buildingData?.name || "Building";
          })() })
        ] })
      ] }),
    ...
    isQuestionModalOpen && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[999999] bg-black bg-opacity-50 flex items-center justify-center p-4", onClick: handleQuestionModalClick, children: /* @__PURE__ */ jsxs("div", { className: "relative bg-white p-6 rounded-lg max-w-lg w-full max-h-[90vh] overflow-y-auto", onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-4", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold", style: { color: "#293056" }, children: "Ask About Building" }),
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-500", children: "Have questions about this building? Our agent will get back to you within 24 hours." }),
...
export {
  BuildingTourScheduling as default
};
