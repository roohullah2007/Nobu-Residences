...
function UserFavourites({ auth, website }) {
      ...
      if (response.ok) {
        ...
        const formattedFavourites = (data.data || []).map((fav) => {
          ...
          return {
            ...
            imageUrl: pickImageUrl(propertyData.images?.[0]) || pickImageUrl(propertyData.imageUrl) || pickImageUrl(propertyData.MediaURL) || pickImageUrl(propertyData.Photos?.[0]) || null,
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { auth, website, blueHeader: true, children: [
    /* @__PURE__ */ jsx(Head, { title: "My Favourites" }),
    /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gray-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2", children: [
            ...
            /* @__PURE__ */ jsx("h1", { className: "text-2xl md:text-3xl font-bold text-gray-900 font-space-grotesk", children: "My Favourites" }),
            /* @__PURE__ */ jsx(Heart, { className: "w-7 h-7 text-red-500", filled: true })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-gray-600 font-work-sans", children: savedProperties.length > 0 ? `You have ${savedProperties.length} saved ${savedProperties.length === 1 ? "property" : "properties"}` : "Properties you've saved while browsing" })
        ] }),
        /* @__PURE__ */ jsxs(
          Link,
          {
      ...
      isLoading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-20", children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 font-work-sans", children: "Loading your favourites..." })
      ] }) : savedProperties.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center", children: [
        /* @__PURE__ */ jsx("div", { className: "w-24 h-24 bg-red-50 rounded-full flex items-center justify-center mx-auto mb-6", children: /* @__PURE__ */ jsx(Heart, { className: "w-12 h-12 text-red-300", filled: false }) }),
        /* @__PURE__ */ jsx("h3", { className: "text-xl font-semibold text-gray-900 font-space-grotesk mb-2", children: "No favourites yet" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-500 font-work-sans max-w-md mx-auto mb-8", children: "Start exploring properties and click the heart icon to save them to your favourites." }),
        /* @__PURE__ */ jsxs(
          Link,
          {
            href: "/search",
      ...
      ] }) : /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6", children: savedProperties.map((property) => /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
        /* @__PURE__ */ jsx(
          PropertyCardV5,
          {
            property,
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx(Heart, { className: "w-5 h-5 text-red-500", filled: true })
          }
        ),
        /* @__PURE__ */ jsxs("div", { className: "absolute bottom-3 right-3 px-2 py-1 bg-black/60 backdrop-blur-sm rounded text-xs text-white font-work-sans z-10", children: [
          "Saved ",
          property.savedDate
        ] })
      ] }, property.id)) })
