...
function BuildingRowThumb({ src, alt }) {
  ...
  if (!src || src === NO_IMAGE_PLACEHOLDER || hasFailed) {
    return /* @__PURE__ */ jsx("div", { className: "h-10 w-10 rounded-lg bg-[#f1f5f9] flex items-center justify-center", children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 text-[#94a3b8]", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" }) }) });
  }
  return /* @__PURE__ */ jsx(
    "img",
    {
...
function BuildingsIndex({ auth, buildings }) {
  ...
  const filteredBuildings = buildings.data.filter((building) => {
    ...
    if (!q) return true;
    return building.name.toLowerCase().includes(q) || building.address.toLowerCase().includes(q) || building.city.toLowerCase().includes(q);
  });
  useEffect(() => {
    setSelectedIds([]);
  }, [searchTerm, statusFilter, typeFilter, featuredFilter]);
  const allVisibleSelected = filteredBuildings.length > 0 && filteredBuildings.every((b) => selectedIds.includes(b.id));
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx(Link, { href: route("admin.buildings.import"), children: /* @__PURE__ */ jsxs("button", { className: "inline-flex items-center px-4 py-2.5 bg-white border border-[#e2e8f0] text-[#0f172a] text-sm font-medium rounded-lg hover:bg-[#f8fafc] transition-colors", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `bg-white rounded-lg border p-4 text-left transition-colors hover:border-[#cbd5e1] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#3b82f6] focus-visible:ring-offset-2 ${statusFilter === "active" ? "border-[#16a34a]" : "border-[#e2e8f0]"}`,
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `bg-white rounded-lg border p-4 text-left transition-colors hover:border-[#cbd5e1] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#3b82f6] focus-visible:ring-offset-2 ${featuredFilter === "featured" ? "border-[#ca8a04]" : "border-[#e2e8f0]"}`,
            children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-lg bg-[#fefce8] flex items-center justify-center text-[#ca8a04]", children: /* @__PURE__ */ jsx("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" }) }) }),
              /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg border border-[#e2e8f0]", children: [
        /* @__PURE__ */ jsxs("div", { className: "p-4 border-b border-[#e2e8f0] flex flex-col lg:flex-row gap-3", children: [
            ...
            /* @__PURE__ */ jsxs(
              "select",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("option", { value: "condominium", children: "Condominium" }),
                  /* @__PURE__ */ jsx("option", { value: "apartment", children: "Apartment" }),
                  /* @__PURE__ */ jsx("option", { value: "townhouse", children: "Townhouse" }),
                  /* @__PURE__ */ jsx("option", { value: "commercial", children: "Commercial" }),
                  /* @__PURE__ */ jsx("option", { value: "mixed_use", children: "Mixed Use" })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              "select",
              {
                ...
                className: "text-sm border-[#e2e8f0] rounded-lg focus:ring-[#3b82f6] focus:border-[#3b82f6]",
                children: [
                  /* @__PURE__ */ jsx("option", { value: "all", children: "Featured + not featured" }),
                  /* @__PURE__ */ jsx("option", { value: "featured", children: "Featured only" })
                ]
              }
            )
          ] })
        ] }),
        selectedIds.length > 0 && /* @__PURE__ */ jsxs("div", { className: "px-4 py-3 border-b border-[#bfdbfe] bg-[#eff6ff] flex items-center justify-between flex-wrap gap-3", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-[#e2e8f0]", children: [
          /* @__PURE__ */ jsx("thead", { className: "bg-[#f8fafc]", children: /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-[#64748b] uppercase tracking-wider hidden md:table-cell", children: "Location" }),
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-[#64748b] uppercase tracking-wider hidden xl:table-cell", children: "Type" }),
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-[#64748b] uppercase tracking-wider", children: "Status" }),
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3 text-center text-xs font-medium text-[#64748b] uppercase tracking-wider hidden xl:table-cell", children: "Featured" }),
            /* @__PURE__ */ jsx("th", { className: "px-6 py-3 text-right text-xs font-medium text-[#64748b] uppercase tracking-wider", children: "Actions" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { className: "bg-white divide-y divide-[#e2e8f0]", children: filteredBuildings.length > 0 ? filteredBuildings.map((building) => /* @__PURE__ */ jsxs("tr", { className: `transition-colors ${selectedIds.includes(building.id) ? "bg-[#eff6ff]" : "hover:bg-[#f8fafc]"}`, children: [
            /* @__PURE__ */ jsx("td", { className: "px-4 py-4 w-10", children: /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
            ...
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs(
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 h-10 w-10", children: /* @__PURE__ */ jsx(BuildingRowThumb, { src: building.main_image, alt: building.name }) }),
                  /* @__PURE__ */ jsxs("div", { className: "ml-3 min-w-0 max-w-[220px]", children: [
                    /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-[#0f172a] truncate group-hover:text-[#3b82f6] transition-colors", title: building.name, children: building.name }),
                    /* @__PURE__ */ jsx("div", { className: "text-xs text-[#94a3b8]", children: building.created_at })
                  ] })
                ]
              }
            ) }),
            /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 max-w-[280px] hidden md:table-cell", children: [
            ...
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap hidden xl:table-cell", children: /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-[#f1f5f9] text-[#475569]", children: getBuildingTypeLabel(building.building_type) }) }),
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: getStatusBadge(building.status) }),
            /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap text-center hidden xl:table-cell", children: building.is_featured ? /* @__PURE__ */ jsx("svg", { className: "w-5 h-5 text-[#eab308] mx-auto", fill: "currentColor", viewBox: "0 0 20 20", children: /* @__PURE__ */ jsx("path", { d: "M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" }) }) : /* @__PURE__ */ jsx("span", { className: "text-[#cbd5e1]", children: "—" }) }),
          ...
          ] }, building.id)) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "7", className: "px-6 py-12 text-center", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
