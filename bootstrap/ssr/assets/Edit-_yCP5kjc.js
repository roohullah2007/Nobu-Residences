...
function BuildingsEdit({ auth, building, developers = [], amenities = [], maintenanceFeeAmenities = [], neighbourhoods = [], subNeighbourhoods = [] }) {
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "mt-8 space-y-8 [&_input]:!bg-white [&_input]:!text-gray-900 [&_textarea]:!bg-white [&_textarea]:!text-gray-900 [&_select]:!bg-white [&_select]:!text-gray-900", children: [
        /* @__PURE__ */ jsx("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:p-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "neighbourhood_id", value: "Neighbourhood" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  id: "neighbourhood_id",
              ...
              /* @__PURE__ */ jsx(InputError, { message: errors.neighbourhood_id, className: "mt-2" }),
              /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 mt-1", children: [
                "Main neighbourhood area.",
                " ",
                /* @__PURE__ */ jsx("a", { href: "/admin/neighbourhoods", target: "_blank", className: "text-indigo-600 hover:text-indigo-800", children: "Manage neighbourhoods" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "sub_neighbourhood_id", value: "Sub-Neighbourhood" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("option", { value: "", children: "Select a sub-neighbourhood..." }),
                    subNeighbourhoods.filter((sn) => !data.neighbourhood_id || sn.neighbourhood_id === parseInt(data.neighbourhood_id)).map((subNeighbourhood) => /* @__PURE__ */ jsxs("option", { value: subNeighbourhood.id, children: [
                      subNeighbourhood.name,
                      " ",
                      subNeighbourhood.neighbourhood_name && `(${subNeighbourhood.neighbourhood_name})`
                    ] }, subNeighbourhood.id))
                  ]
                }
              ),
              /* @__PURE__ */ jsx(InputError, { message: errors.sub_neighbourhood_id, className: "mt-2" }),
              /* @__PURE__ */ jsxs("p", { className: "text-xs text-gray-500 mt-1", children: [
                "Specific sub-area within the neighbourhood.",
                " ",
                /* @__PURE__ */ jsx("a", { href: "/admin/sub-neighbourhoods", target: "_blank", className: "text-indigo-600 hover:text-indigo-800", children: "Manage sub-neighbourhoods" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-6 sm:p-8", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "developer_id", value: "Developer" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  id: "developer_id",
                  ...
                  children: [
                    /* @__PURE__ */ jsx("option", { value: "", children: "Select a developer" }),
                    developers.map((developer) => /* @__PURE__ */ jsx("option", { value: developer.id, children: developer.name }, developer.id))
                  ]
                }
              ),
              /* @__PURE__ */ jsx(InputError, { message: errors.developer_id, className: "mt-2" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-3", children: [
              /* @__PURE__ */ jsx(InputLabel, { htmlFor: "price_range", value: "Price Range" }),
              /* @__PURE__ */ jsx(
                TextInput,
                {
                  id: "price_range",
              ...
              /* @__PURE__ */ jsx(InputError, { message: errors.price_range, className: "mt-2" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "sm:col-span-3", children: [
