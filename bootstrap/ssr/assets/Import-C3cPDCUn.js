    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: [
      ...
      step === "map" && upload && /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl p-6", children: [
          ...
          Object.values(mapping).includes("street_address_2") && /* @__PURE__ */ jsxs("p", { className: "mt-3 text-xs text-gray-500", children: [
            /* @__PURE__ */ jsx("span", { className: "font-medium text-gray-700", children: "Address handling:" }),
            ` the secondary street column is merged into the main Address ("Street 1 & Street 2, City" — never duplicated when Street 1 already contains it), and numbered ranges like "1-208 Cerberus Trail" expand automatically into the building's Additional Street Addresses — exactly like the Create Building page. Pick a different "Import As" target to override this.`
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl p-6", children: [
