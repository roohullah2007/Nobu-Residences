    ...
    submitStatus === "success" ? /* @__PURE__ */ jsxs("div", { className: "py-8 text-center", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mb-6 border-b", children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `px-4 py-2 font-medium transition-colors ${contactMethod === "form" ? "text-[#293056] border-b-2 border-[#293056]" : "text-gray-500 hover:text-gray-700"}`,
            children: [
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `px-4 py-2 font-medium transition-colors ${contactMethod === "phone" ? "text-[#293056] border-b-2 border-[#293056]" : "text-gray-500 hover:text-gray-700"}`,
            children: [
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className: `px-4 py-2 font-medium transition-colors ${contactMethod === "email" ? "text-[#293056] border-b-2 border-[#293056]" : "text-gray-500 hover:text-gray-700"}`,
            children: [
      ...
      contactMethod === "form" && /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
          ...
          errors.question && /* @__PURE__ */ jsx("p", { className: "text-red-500 text-sm mt-1", children: errors.question })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: isSubmitting ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center", children: [
              /* @__PURE__ */ jsx("div", { className: "animate-spin rounded-full h-5 w-5 border-b-2 mr-2", style: { borderBottomColor: buttonTertiaryText } }),
              "Sending Question..."
            ] }) : "Send Question"
          }
        )
