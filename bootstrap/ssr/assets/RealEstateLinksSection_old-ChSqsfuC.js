...
function RealEstateLinksSection() {
  ...
  return /* @__PURE__ */ jsx("section", { className: " bg-white", children: /* @__PURE__ */ jsx("div", { className: "mx-auto md:px-0", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-lg shadow-sm", children: [
