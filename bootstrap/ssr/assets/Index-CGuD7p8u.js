      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `bg-white rounded-lg border p-4 text-left transition-colors hover:border-[#cbd5e1] ${statusFilter === "all" ? "border-[#0f172a] ring-1 ring-[#0f172a]" : "border-[#e2e8f0]"}`,
