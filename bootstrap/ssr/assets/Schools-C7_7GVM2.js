...
function Schools({ auth, schools: initialSchools = [], pagination = null }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Schools", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "py-12", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden shadow-sm sm:rounded-lg", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-gray-900", children: [
      statusMessage && /* @__PURE__ */ jsxs("div", { className: `mb-4 flex items-center justify-between rounded-md border px-4 py-3 text-sm ${statusMessage.type === "success" ? "bg-green-50 border-green-200 text-green-800" : "bg-red-50 border-red-200 text-red-700"}`, children: [
        /* @__PURE__ */ jsx("span", { children: statusMessage.text }),
        /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
