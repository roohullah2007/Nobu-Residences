...
function EditHomePage({ auth }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title, children: [
    ...
    iconActionError && /* @__PURE__ */ jsxs("div", { className: "fixed top-4 right-4 z-50 flex items-center gap-3 rounded-md bg-red-50 border border-red-200 px-4 py-3 text-sm text-red-700 shadow-lg", children: [
      /* @__PURE__ */ jsx("span", { children: iconActionError }),
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
