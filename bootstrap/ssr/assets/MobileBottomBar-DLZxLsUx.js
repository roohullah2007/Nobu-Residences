...
function MobileBottomBar() {
  ...
  const contactPhone = currentWebsite?.agent_info?.agent_phone || currentWebsite?.contact_info?.agent?.phone || currentWebsite?.contact_info?.phone || "";
