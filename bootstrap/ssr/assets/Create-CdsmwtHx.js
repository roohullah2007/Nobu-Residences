...
function Create({ auth, buildings = [], defaultAgent = null, defaultBranding = null, defaultContactInfo = {}, defaultSocialMedia = {}, cloudflareEnabled = false, cnameTarget = "", preselectedBuildingId = null }) {
          ...
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: "font-medium text-gray-900 truncate", title: b.name, children: b.name }),
        ...
        return /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden rounded-2xl border border-gray-200 shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-gray-900", children: [
          chosenBuilding && /* @__PURE__ */ jsxs("div", { className: "mb-6 border border-indigo-200 bg-indigo-50/40 rounded-lg p-4 flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "font-medium text-gray-900 truncate", title: chosenBuilding.name, children: chosenBuilding.name }),
              /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500 truncate", title: chosenBuilding.address || chosenBuilding.city || "", children: chosenBuilding.address || chosenBuilding.city || "—" })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
            ...
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-gray-100 bg-gray-50/70 p-5 sm:p-6", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  cloudflareEnabled && !typedDomain && /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-green-700", children: "This domain will be registered on Cloudflare automatically — SSL activates as soon as the customer creates one CNAME record." }),
                ...
                typedDomain && /* @__PURE__ */ jsx("div", { className: "md:col-span-2 rounded-xl border border-indigo-100 bg-indigo-50/50 p-4 sm:p-5", children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "mt-2 text-xs text-gray-500", children: "DNS changes can take a few minutes to propagate. The hostname is registered on Cloudflare automatically after the website is created — activation is checked every few minutes and the status page shows live progress." })
                  ] })
                ] }) }),
                /* @__PURE__ */ jsxs("div", { children: [
