          ...
          /* @__PURE__ */ jsxs("div", { className: `flex flex-col flex-grow items-start ${config.content} box-border`, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-start gap-2 w-full", children: [
              ...
              property.source === "building" ? (
                ...
                /* @__PURE__ */ jsx("div", { className: `flex items-center justify-start w-full min-h-8 font-work-sans font-normal text-sm leading-6 tracking-tight text-[#293056]`, children: `${property.unitsForSale ?? "—"} Condos for Sale | ${property.unitsForRent ?? "—"} Condos for Rent` })
              ) : (
