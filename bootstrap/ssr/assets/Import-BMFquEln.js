    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "sm:flex sm:items-center sm:justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-gray-700", children: "Upload a CSV, map its columns to building fields, and the rows import gradually in the background. Developers, neighbourhoods, and sub-neighbourhoods are matched by name and created automatically." })
        ] }),
        /* @__PURE__ */ jsx(
          Link,
          {
      ...
      step === "importing" && progress && /* @__PURE__ */ jsxs("div", { className: "bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl p-6 space-y-5", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "text-sm font-semibold text-gray-900", children: "Importing in the background" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500", children: "Buildings are processed gradually in batches. You can leave this page — the import keeps running on the server." })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
