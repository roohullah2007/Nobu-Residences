      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: `relative w-full ${config.image} overflow-hidden bg-gray-100 rounded-t-xl`, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute top-2 left-2 right-2 flex justify-between items-center gap-2.5 h-8", children: [
            /* @__PURE__ */ jsx("span", { className: `flex items-center justify-center ${config.chip} h-8 rounded-full font-bold tracking-tight whitespace-nowrap shadow-sm bg-white text-[#293056] border border-gray-200`, children: getTransactionTypeDisplay() }),
          ...
          !property.has_contact_access && /* @__PURE__ */ jsx("div", { className: "absolute bottom-2 left-2 right-2", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-1 bg-orange-500 bg-opacity-90 text-white px-2 py-1 rounded-full text-xs font-medium shadow-sm", children: [
            /* @__PURE__ */ jsx(Lock, { className: "w-3 h-3" }),
            /* @__PURE__ */ jsx("span", { children: "Address Protected" })
          ] }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: `flex flex-col items-start ${config.content} box-border`, children: [
          /* @__PURE__ */ jsx("div", { className: `flex items-center justify-start w-full min-h-8 pb-2 border-b border-gray-200 font-work-sans font-bold ${config.title} leading-7 tracking-tight text-[#293056]`, children: property.property_type }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-start gap-2 w-full flex-1", children: [
            /* @__PURE__ */ jsxs("div", { className: `flex items-center justify-between w-full min-h-8 pb-2 border-b border-gray-200`, children: [
              /* @__PURE__ */ jsx("div", { className: `font-work-sans font-normal ${config.details} leading-6 tracking-tight text-[#293056] flex-1`, children: property.address }),
              !property.has_contact_access && /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1 text-orange-600 ml-2", children: /* @__PURE__ */ jsx(Lock, { className: "w-3 h-3" }) })
            ] }),
            ...
            property.area && /* @__PURE__ */ jsxs("div", { className: `flex items-center justify-start w-full min-h-8 pb-2 border-b border-gray-200 font-work-sans font-normal ${config.details} leading-6 tracking-tight text-[#293056]`, children: [
              property.area,
              " ",
              property.area_unit || "sqft"
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between w-full min-h-8", children: [
              !property.has_contact_access && /* @__PURE__ */ jsxs("div", { className: `font-work-sans font-normal text-sm leading-6 tracking-tight text-gray-600`, children: [
                "Contact: $",
              ...
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: property.has_contact_access ? "View Full Details" : "View & Contact"
                }
              )
            ] })
          ] })
...
export {
  ProtectedPropertyCard as default
};
