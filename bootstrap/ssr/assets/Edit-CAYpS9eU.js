...
function Edit({ auth }) {
  ...
  const handleSubmit = (e) => {
    ...
    router.post(route("admin.websites.update", website.id), transformedData, {
      ...
      onError: (errors2) => {
        console.error("Form errors:", errors2);
      }
    });
  };
  if (!website) {
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-white shadow rounded-lg border border-gray-200 mb-6", children: /* @__PURE__ */ jsxs("div", { className: "px-4 py-5 sm:p-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500", children: "Add the custom domain to Ploi as a site alias and request a Let's Encrypt SSL certificate. The DNS A record must point to your Ploi server first." })
          ] })
        ] }),
