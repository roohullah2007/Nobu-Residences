...
const NearbySchools = ({ propertyData = null }) => {
  ...
  `schools-${Math.random().toString(36).substr(2, 9)}`;
  const getSchoolsData = () => {
    ...
    if (propertyData?.NearbySchools && Array.isArray(propertyData.NearbySchools) && propertyData.NearbySchools.length > 0) {
      schoolsData2 = propertyData.NearbySchools.map((school) => ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "idx-nearby-schools-boundary", children: /* @__PURE__ */ jsxs("div", { className: "nearby-schools-container", children: [
      /* @__PURE__ */ jsx("h3", { className: "title", children: "Nearby Schools" }),
      /* @__PURE__ */ jsxs("div", { className: "schools-table-container", children: [
        /* @__PURE__ */ jsxs("table", { className: "schools-table", children: [
          /* @__PURE__ */ jsx("thead", { className: "table-header", children: /* @__PURE__ */ jsxs("tr", { children: [
            /* @__PURE__ */ jsx("th", { children: "Distance" }),
            /* @__PURE__ */ jsx("th", { children: "School" })
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { className: "table-body", children: displayedSchools.map((school, index) => /* @__PURE__ */ jsxs("tr", { className: "school-row", children: [
            /* @__PURE__ */ jsxs("td", { className: "distance-cell", children: [
              /* @__PURE__ */ jsx("div", { className: "distance-km", children: school.distance_km }),
              /* @__PURE__ */ jsx("div", { className: "distance-walk", children: school.walk_time })
            ] }),
            /* @__PURE__ */ jsxs("td", { children: [
              /* @__PURE__ */ jsx("a", { href: school.url, className: "school-link", children: school.name }),
              /* @__PURE__ */ jsx("div", { className: "school-details", children: school.board })
            ] })
          ] }, index)) })
        ] }),
        schoolsData.length > 3 && /* @__PURE__ */ jsx("div", { className: "schools-toggle-container", children: /* @__PURE__ */ jsx(
          "button",
          {
