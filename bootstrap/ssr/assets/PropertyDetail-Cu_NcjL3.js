...
import ViewingRequestModal from "./ViewingRequestModal-BBfxqnQH.js";
import LoginModal from "./LoginModal-CkvRiYR7.js";
import PropertyHeader from "./PropertyHeader-ozMZwPUX.js";
import PropertyGallery from "./PropertyGallery-Bqb5p4py.js";
import MobileBottomBar from "./MobileBottomBar-DLZxLsUx.js";
import PropertySections from "./PropertySections-DTOPjdIn.js";
import "./Dropdown-CDFef2yc.js";
import "./TextInput-BjeU_XkG.js";
import TourSchedulingComponent from "./TourScheduling-Dzqg5Ury.js";
...
function PropertyDetail({ auth, siteName, siteUrl, year, listingKey, propertyData: initialPropertyData, propertyImages: initialImages, website, buildingData: initialBuildingData, aiDescription: initialAiDescription }) {
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { siteName, siteUrl, year, auth, website, blueHeader: true, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "idx mx-auto overflow-hidden bg-primary pb-24 md:pb-0", children: /* @__PURE__ */ jsxs("div", { className: "px-4 xl:px-0 max-w-[1280px] mx-auto pt-8 md:pt-12", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-6 w-full", children: [
        /* @__PURE__ */ jsx("div", { className: "w-full min-w-0 lg:flex-1 xl:flex-none xl:w-[950px]", children: /* @__PURE__ */ jsx(
          PropertySections,
          {
            propertyData: displayData,
            propertyImages,
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden md:flex w-full max-w-[309px] flex-shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-6 w-full", children: [
