...
function Create({ auth, buildings = [], buildingIdsWithWebsite = [], cloudflareEnabled = false, cnameTarget = "", preselectedBuildingId = null }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Create New Website", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: `max-w-5xl mx-auto space-y-6 ${lightFormClass}`, children: [
      ...
      selectedBuilding && /* @__PURE__ */ jsx("form", { onSubmit: submit, ref: confirmPanelRef, children: /* @__PURE__ */ jsx("div", { className: "bg-white overflow-hidden rounded-2xl border border-indigo-200 shadow-sm", children: /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-5", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-1", children: [
