...
function PropertyEnquiryModal({ isOpen, onClose, propertyData, auth }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative bg-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto mx-4", children: [
      /* @__PURE__ */ jsx("div", { className: "border-b border-gray-200 p-6 sticky top-0 bg-white z-10", children: /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "font-space-grotesk font-bold text-2xl text-[#293056] mb-2", children: "Property Enquiry" }),
          /* @__PURE__ */ jsx("p", { className: "font-work-sans text-sm text-gray-600", children: formatAddress() })
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      submitStatus === "success" ? /* @__PURE__ */ jsxs("div", { className: "p-8 text-center", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "font-space-grotesk font-bold text-xl text-[#293056] mb-2", children: "Enquiry Sent Successfully!" }),
        /* @__PURE__ */ jsx("p", { className: "font-work-sans text-gray-600", children: "We'll get back to you within 24 hours." })
      ] }) : (
        /* Form */
        /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "p-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
            ...
            /* @__PURE__ */ jsx(
              "input",
              {
                ...
                className: `w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#293056] focus:ring-opacity-50 focus:border-transparent transition-colors ${errors.name ? "border-red-500" : "border-gray-300"}`,
                required: true
              }
            ),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
            ...
            /* @__PURE__ */ jsx(
              "input",
              {
                ...
                onChange: handleChange,
                className: `w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#293056] focus:ring-opacity-50 focus:border-transparent transition-colors ${errors.email ? "border-red-500" : "border-gray-300"}`,
                required: true
              }
            ),
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
            ...
            /* @__PURE__ */ jsx(
              "textarea",
              {
                ...
                onChange: handleChange,
                rows: 4,
                className: `w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#293056] focus:ring-opacity-50 focus:border-transparent transition-colors resize-none ${errors.message ? "border-red-500" : "border-gray-300"}`,
                required: true
              }
            ),
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 rounded-lg p-4 mb-4", children: [
            /* @__PURE__ */ jsx("h4", { className: "font-work-sans font-semibold text-sm text-gray-700 mb-2", children: "Property Details" }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-1 text-sm text-gray-600", children: [
              ...
              propertyData?.ListPrice && /* @__PURE__ */ jsxs("p", { children: [
                /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Price:" }),
                " $",
                propertyData.ListPrice?.toLocaleString()
              ] }),
              (propertyData?.BedroomsTotal || propertyData?.bedrooms) && /* @__PURE__ */ jsxs("p", { children: [
                /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Bedrooms:" }),
                " ",
                propertyData.BedroomsTotal || propertyData.bedrooms
              ] }),
              (propertyData?.BathroomsTotal || propertyData?.bathrooms) && /* @__PURE__ */ jsxs("p", { children: [
                /* @__PURE__ */ jsx("span", { className: "font-medium", children: "Bathrooms:" }),
                " ",
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: isSubmitting ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center", children: [
                /* @__PURE__ */ jsx("div", { className: "animate-spin rounded-full h-5 w-5 border-b-2 mr-2", style: { borderColor: buttonTertiaryText } }),
                "Sending Enquiry..."
              ] }) : "Send Enquiry"
            }
          )
...
export {
  PropertyEnquiryModal as default
};
