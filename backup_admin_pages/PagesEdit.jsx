...
export default function PagesEdit({ auth, page, title }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('admin.pages.manage.update', page.id));
    };
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Update your page content and SEO settings.
                        </p>
                    </div>
                    <div className="flex space-x-3">
                        <Link href={route('admin.pages.manage.show', page.id)}>
                            <SecondaryButton>
                                View Page
                            </SecondaryButton>
                        </Link>
                ...
                <form onSubmit={submit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="mt-1 flex rounded-md shadow-sm">
                                    ...
                                    <TextInput
                                        id="slug"
                                        type="text"
                                        className="flex-1 block w-full rounded-none"
                                        value={data.slug}
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                            <p><span className="font-medium">Created:</span> {new Date(page.created_at).toLocaleString()}</p>
                            <p><span className="font-medium">Last Updated:</span> {new Date(page.updated_at).toLocaleString()}</p>
                            <p><span className="font-medium">Author:</span> {page.user?.name || 'Unknown'}</p>
                        </div>
                    </div>
