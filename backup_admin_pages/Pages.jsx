...
export default function Pages({ title, pages }) {
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white shadow rounded-lg p-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Link
                            href={route('admin.pages.manage.create')}
                ...
                <div className="bg-white shadow rounded-lg p-6">
                    <div className="flex items-center space-x-4">
                        <div className="flex-1">
                            <label htmlFor="search" className="sr-only">Search pages</label>
                        ...
                        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p className="text-sm text-gray-700">
                                    Showing <span className="font-medium">{pages.from || 0}</span> to{' '}
                                    <span className="font-medium">{pages.to || 0}</span> of{' '}
                                    <span className="font-medium">{pages.total || 0}</span> results
                                </p>
                            </div>
                            <div>
