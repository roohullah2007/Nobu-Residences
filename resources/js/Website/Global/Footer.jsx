...
const Footer = ({ 
    ...
    const displayContactInfo = {
        ...
        agent: {
            name: useGlobalContact ? contactInfo?.agent?.name : contactSettings?.custom_agent_name,
            title: useGlobalContact ? contactInfo?.agent?.title : contactSettings?.custom_agent_title
        }
    };
                        ...
                        <div className="flex flex-col items-start gap-3 md:gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {showAddress && displayContactInfo?.address && (
                                    <p className="font-work-sans font-normal text-sm leading-6 tracking-[-0.03em] text-white">
                                        {displayContactInfo.address.split(',').map((line, index) => (
                                            <span key={index}>
                                                {line.trim()}
                                                {index < displayContactInfo.address.split(',').length - 1 && <br />}
                                            </span>
                                        ))}
                                    </p>
                                )}
                        ...
                        <div className="flex flex-col items-start gap-3 md:gap-4">
                            ...
                            <div className="flex gap-4">
                                ...
                                {showFacebook && socialMedia?.facebook && (
                                    <Link href={socialMedia.facebook} className="text-white hover:text-gray-300 transition-colors">
                                ...
                                {showInstagram && socialMedia?.instagram && (
                                    <Link href={socialMedia.instagram} className="text-white hover:text-gray-300 transition-colors">
                                        <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                ...
                                {showLinkedin && socialMedia?.linkedin && (
                                    <Link href={socialMedia.linkedin} className="text-white hover:text-gray-300 transition-colors">
                                        <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
