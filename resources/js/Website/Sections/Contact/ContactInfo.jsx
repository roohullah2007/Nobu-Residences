...
export default function ContactInfo({ website }) {
  ...
  const secondaryColor = website?.brand_colors?.secondary || '#293056';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8">
        <h3 className="font-space-grotesk font-bold text-xl text-[#293056] mb-6">
          Get in Touch
        </h3>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start space-x-4">
            <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: `${primaryColor}20` }}>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="flex items-center space-x-4 mb-6">
          <div className="w-16 h-16 rounded-full bg-gray-300 border-2 border-white flex items-center justify-center overflow-hidden">
            <img 
              ...
              alt={contactInfo.agent?.name || 'Property Manager'}
            ...
            <div className="absolute inset-0 bg-gray-300 rounded-full flex items-center justify-center hidden">
              <span className="font-work-sans font-medium text-sm text-[#1C1463]">
                {contactInfo.agent?.name?.split(' ').map(n => n[0]).join('') || 'JG'}
              </span>
            </div>
          </div>
          <div>
            <h4 className="font-space-grotesk font-bold text-lg text-[#293056]">
              {contactInfo.agent?.name || 'Jatin Gill'}
            </h4>
            <p className="font-work-sans text-gray-600">
              {contactInfo.agent?.title || 'Property Manager'}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <button 
            className="w-full py-3 text-white rounded-full font-work-sans font-medium transition-colors hover:bg-opacity-90"
