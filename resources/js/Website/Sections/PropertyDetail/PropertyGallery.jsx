            ...
            <div className="flex flex-col justify-between p-4 md:p-6 flex-1 min-h-[500px] lg:min-h-0">
              <div className="flex flex-col gap-6 md:gap-8 lg:gap-10 mb-[30px] md:mb-0">
                ...
                <div className="flex flex-col gap-4 md:gap-6">
                  ...
                  <h2 className="font-red-hat font-bold text-lg md:text-xl text-[#252B37] text-center">
                    {(() => {
              ...
              <div className="enquire-cta rounded-full h-12 min-h-[48px] flex-shrink-0 flex items-center justify-center w-full mt-4" style={{ backgroundColor: buttonTertiaryBg }}>
                <button
