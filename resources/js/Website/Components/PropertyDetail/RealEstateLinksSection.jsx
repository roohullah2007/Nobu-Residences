      ...
      <div className="mx-auto px-4 md:px-0">
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="mb-12">
            ...
            {/* Show More Button */}
            <div className="mt-6">
              <button id="showMoreBtn" className="flex items-center text-teal-600 hover:text-teal-700 transition-colors duration-200 font-medium">
            ...
            <div id="additionalContent" className="hidden mt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                {/* Additional Column 1 */}
                <div className="space-y-4">
                  <a href="#" className="block text-gray-700 hover:text-blue-600 transition-colors duration-200">
