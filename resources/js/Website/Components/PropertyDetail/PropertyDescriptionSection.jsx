    ...
    <section className="bg-white md:py-8 ">
      <div className="mx-auto max-w-[950px]">
        <div className="bg-white">
          ...
          <div className="space-y-4 md:space-y-6 text-sm md:text-base leading-relaxed md:leading-normal" style={{ fontFamily: "'Helvetica', 'Arial', sans-serif", fontWeight: 400 }}>
