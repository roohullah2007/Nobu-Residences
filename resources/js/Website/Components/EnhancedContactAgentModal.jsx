                    ...
                    <>
                        ...
                        {contactMethod === 'form' && (
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-4">
                                    <label htmlFor="question" className="block text-gray-700 mb-1 font-medium text-sm">
                                        Your Message
                                    </label>
                                    <textarea
                                        id="question"
                        ...
                        {propertyData && (
                            <div className="mt-6 pt-4 border-t">
                                <p className="text-sm text-gray-600">
                                    Inquiring about: <span className="font-medium">{propertyData?.UnparsedAddress || propertyData?.address || 'Property'}</span>
                                </p>
                            </div>
                        )}
                    </>
