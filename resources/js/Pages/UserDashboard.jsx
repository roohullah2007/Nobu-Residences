...
export default function UserDashboard({ auth, siteName, siteUrl, year }) {
  ...
  const savedProperties = [
    ...
    },
    {
      ...
      price: "$2,000/month",
      address: "104 Devonshire Avenue",
      location: "London South, ON",
      beds: "2",
      baths: "1",
      sqft: "900 sqft",
      type: "For Rent",
  ...
  const recentSearches = [
    ...
    {
      id: 2,
      query: "Rental properties downtown",
      location: "Toronto, ON", 
      priceRange: "$1500 - $2500/month",
      date: "3 days ago",
      results: 32
    },
    {
      id: 3,
      query: "Detached homes",
            ...
            <div>
              ...
              {savedProperties.length > 0 ? (
                    ...
                    <div key={property.id} className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                      <div className="relative">
                        ...
                        <div className="absolute top-3 left-3">
                          <span className="bg-white text-[#293056] px-2 py-1 rounded text-xs font-medium">
                            {property.type}
                          </span>
                        </div>
                        <button
                          onClick={() => removeSavedProperty(property.id)}
                          className="absolute top-3 right-3 bg-white rounded-full p-2 shadow-sm hover:bg-red-50 transition-colors"
                        >
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="red" stroke="red" strokeWidth="2">
                      ...
                      <div className="p-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-xl font-space-grotesk font-bold text-[#293056]">
                            {property.price}
                          </span>
                        ...
                        <div className="mt-4 flex space-x-2">
                          <Link
                            ...
                            className="flex-1 bg-[#293056] text-white text-center py-2 rounded-lg text-sm font-medium hover:bg-[#1e2142] transition-colors"
                          >
                            View Details
                          </Link>
                ...
                <div className="text-center py-12">
                  ...
                  <Link
                    href="/search"
                    className="inline-flex items-center px-4 py-2 bg-[#293056] text-white rounded-lg font-medium hover:bg-[#1e2142] transition-colors"
                  >
                    Browse Properties
                  </Link>
                </div>
                  ...
                  <div key={search.id} className="bg-white border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-500 mt-1">{search.date}</p>
                      </div>
                      <button
