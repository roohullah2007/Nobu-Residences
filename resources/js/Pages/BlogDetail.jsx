...
export default function BlogDetail({ auth, siteName = 'NobuResidence', siteUrl, year, website, blog, relatedPosts, recentPosts }) {
    ...
    return (
        <MainLayout auth={auth} website={website}>
            ...
            {/* Hero Section - Same style as Blog listing page */}
            <section
                ...
                <div className="relative z-10 w-full max-w-[1280px] mx-auto px-4 md:px-0">
                    <div className="max-w-3xl text-left text-white">
                        ...
                        <h3 className="font-work-sans font-normal text-sm leading-6 -tracking-wider mb-4">
                            / <Link href="/blogs" className="hover:underline">Blog</Link> / {blog.blog_category?.name || blog.category || 'Article'}
                        </h3>

                        {/* Main Title */}
                        <h1 className="font-space-grotesk text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4">
                            {blog.title}
                        </h1>

                        {/* Meta Info */}
                        <div className="flex flex-wrap items-center gap-4 text-white/90 font-work-sans text-sm">
                ...
                <div className="max-w-[1280px] mx-auto px-4">
                    ...
                    <div className="py-8 border-t border-gray-200">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <h3 className="font-space-grotesk font-bold text-xl text-[#293056]">Share this article</h3>
