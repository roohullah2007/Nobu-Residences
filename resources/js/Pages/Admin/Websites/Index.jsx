...
export default function Index({ auth }) {
    ...
    // query parameter is only the fallback for sites without a domain yet.
    ...
    // Get production URL (for domains)
                                                ...
                                                <div className="relative inline-block text-left">
                                                    ...
                                                    {openDropdownId === website.id && (
                                                        <>
                                                            ...
                                                            <div className="absolute right-0 z-50 mt-2 w-56 bg-white border border-[#e2e8f0] rounded-lg shadow-lg">
                                                                <div className="py-1">
                                                                    {/* Preview with query parameter */}
                                                                    <a
                                                                    ...
                                                                    {/* Production domain link (if domain is set) */}
                                                                    {getProductionUrl(website) && (
                                                                        <a
                                                                            ...
                                                                            className="flex items-center px-4 py-2 text-sm text-[#0f172a] hover:bg-[#f8fafc] transition-colors"
                                                                        >
                                                                            <svg className="w-4 h-4 mr-3 text-[#16a34a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
