    ...
    const renderIconGrid = (category) => {
        ...
        return (
            <div className="grid grid-cols-6 gap-4 p-4 bg-gray-50 rounded-lg">
                {icons.map((icon) => (
                    <div key={icon.id} className="flex flex-col items-center p-2 bg-white rounded border hover:shadow-md">
                        ...
                        <span className="text-xs text-center font-medium">{icon.name}</span>
                    </div>
                ))}
                <button
                    onClick={() => {
                    ...
                    <div className="p-6">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            {activeTab === 'about' && (
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                {data.content.about?.image && (
                                                    <div className="flex items-center space-x-3">
                                                        <img 
                                                            ...
                                                            alt={data.content.about?.image_alt || 'About section image'} 
                                                            className="w-20 h-20 object-cover rounded-lg border"
                                                        />
                                                        <div className="text-sm text-gray-600">
                                                            <p className="font-medium">Current Image:</p>
                                                ...
                                                <p className="text-sm text-gray-500">
                                                    Upload a new image for the about section. Recommended size: 600x400px
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            />
                                            <p className="text-sm text-gray-500 mt-1">
                                                Provide a brief description of the image for screen readers and accessibility
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-lg">
                                        ...
                                        <div>
                                            <label className="block text-sm font-semibold text-gray-700 mb-2">Content Text</label>
                                            <textarea
                                            ...
                                            <p className="text-sm text-gray-500 mt-2">
                                                This content supports basic HTML tags like &lt;strong&gt;, &lt;em&gt;, &lt;a href=""&gt;, &lt;br&gt;, etc.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {activeTab === 'carousel' && (
                                <div className="space-y-6">
                                    <div className="bg-gray-50 p-6 rounded-lg">
                                        <h3 className="text-lg font-semibold text-gray-900 mb-4">Property Carousel Settings</h3>
                                        <p className="text-sm text-gray-600 mb-6">Configure the property listings displayed on your home page</p>
                                        
                                        {/* For Rent Carousel */}
                                        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                                            <div className="flex items-center justify-between mb-4">
                                                <h4 className="text-lg font-medium text-gray-900">Properties for Rent</h4>
                                                <label className="flex items-center">
                                                    ...
                                                    />
                                                    <span className="ml-2 text-sm text-gray-600">Enable this carousel</span>
                                                </label>
                                            </div>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <select
                                                        value={data.content.carousel_settings?.for_rent?.property_subtype || 'Condo'}
                                        ...
                                        <div className="bg-white border border-gray-200 rounded-lg p-6">
                                            <div className="flex items-center justify-between mb-4">
                                                <h4 className="text-lg font-medium text-gray-900">Properties for Sale</h4>
                                                <label className="flex items-center">
                                                    <input
                                                        type="checkbox"
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <label className="block text-sm font-medium text-gray-700 mb-2">Property Type</label>
                                                    <select
                                                        value={data.content.carousel_settings?.for_sale?.property_subtype || 'Condo'}
                            ...
                            {activeTab === 'faq' && (
                                <div className="space-y-6">
                                    <div className="bg-gray-50 p-6 rounded-lg">
                                        <div className="flex items-center justify-between mb-4">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600 mt-1">Manage frequently asked questions displayed on your home page</p>
                                            </div>
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    ...
                                                    className="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                                />
                                                <span className="ml-2 text-sm text-gray-600">Enable FAQ section</span>
                                            </label>
                                        </div>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg p-6">
                                        <h4 className="text-lg font-medium text-gray-900 mb-4">FAQ Items</h4>
                                        {data.content.faq?.items?.map((item, index) => (
                                            <div key={index} className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                                                <div className="flex items-center justify-between mb-3">
                                                    <h5 className="text-sm font-semibold text-gray-800">FAQ #{index + 1}</h5>
                                                    <button
                                                        type="button"
                                ...
                                <div className="space-y-6">
                                    <div className="bg-gray-50 p-6 rounded-lg">
                                        <div className="flex items-center justify-between mb-4">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600 mt-1">Customize your website footer content and links</p>
                                            </div>
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    ...
                                                    {data.content.footer?.logo_url && (
                                                        <div className="flex items-center space-x-3">
                                                            ...
                                                            <div className="text-sm text-gray-600">
                                                                ...
                                                                <p className="break-all">{data.content.footer.logo_url}</p>
                                                            </div>
                                                        </div>
                                                    )}
                                                    <p className="text-sm text-gray-500">
                                                        Upload a new logo image. Recommended size: 200x60px or similar aspect ratio
                                                    </p>
                                                </div>
                                            </div>
                                            <div>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <textarea
                                                ...
                                                rows={3}
                                                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                                placeholder="Experience luxury living at Nobu Residences in the heart of Toronto."
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg p-6">
                                        ...
                                        {data.content.footer?.quick_links?.map((link, index) => (
                                            <div key={index} className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                                                <div className="flex items-center justify-between mb-3">
                                                    <h5 className="text-sm font-semibold text-gray-800">Link #{index + 1}</h5>
                                                    <button
                                                        type="button"
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg p-6">
                                        <h4 className="text-lg font-medium text-gray-900 mb-4">Contact Information Display</h4>
                                        <div className="space-y-3">
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={data.content.footer?.contact_info?.use_global_contact || false}
                                                    onChange={(e) => updateFooterField('contact_info', {
                                                        ...data.content.footer?.contact_info,
                                                        use_global_contact: e.target.checked
                                                    })}
                                                    className="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                                />
                                                <span className="ml-2 text-sm text-gray-700">Use global contact information</span>
                                            </label>
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={data.content.footer?.contact_info?.show_phone || false}
                                                    onChange={(e) => updateFooterField('contact_info', {
                                                        ...data.content.footer?.contact_info,
                                            ...
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={data.content.footer?.contact_info?.show_email || false}
                                                    onChange={(e) => updateFooterField('contact_info', {
                                                        ...data.content.footer?.contact_info,
                                            ...
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={data.content.footer?.contact_info?.show_address || false}
                                                    onChange={(e) => updateFooterField('contact_info', {
                                                        ...data.content.footer?.contact_info,
                                                    ...
                                                    className="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                                />
                                                <span className="ml-2 text-sm text-gray-700">Show address</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-lg p-6">
                                        <h4 className="text-lg font-medium text-gray-900 mb-4">Social Media Display</h4>
                                        <div className="space-y-3">
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={data.content.footer?.social_media?.use_global_social || false}
                                                    onChange={(e) => updateFooterField('social_media', {
                                                        ...data.content.footer?.social_media,
                                                        use_global_social: e.target.checked
                                                    })}
                                                    className="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                                />
                                                <span className="ml-2 text-sm text-gray-700">Use global social media links</span>
                                            </label>
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={data.content.footer?.social_media?.show_facebook || false}
                                                    onChange={(e) => updateFooterField('social_media', {
                                                        ...data.content.footer?.social_media,
                                                        show_facebook: e.target.checked
                                                    })}
                                                    className="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                                />
                                                <span className="ml-2 text-sm text-gray-700">Show Facebook</span>
                                            </label>
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={data.content.footer?.social_media?.show_instagram || false}
                                                    onChange={(e) => updateFooterField('social_media', {
                                                        ...data.content.footer?.social_media,
                                                        show_instagram: e.target.checked
                                                    })}
                                                    className="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                                />
                                                <span className="ml-2 text-sm text-gray-700">Show Instagram</span>
                                            </label>
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={data.content.footer?.social_media?.show_twitter || false}
                                                    onChange={(e) => updateFooterField('social_media', {
                                                        ...data.content.footer?.social_media,
                                                        show_twitter: e.target.checked
                                                    })}
                                                    className="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                                />
                                                <span className="ml-2 text-sm text-gray-700">Show Twitter</span>
                                            </label>
                                            <label className="flex items-center">
                                                <input
                                                    type="checkbox"
                                                    checked={data.content.footer?.social_media?.show_linkedin || false}
                                                    onChange={(e) => updateFooterField('social_media', {
                                                        ...data.content.footer?.social_media,
                                                        show_linkedin: e.target.checked
                                                    })}
                                                    className="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                                />
                                                <span className="ml-2 text-sm text-gray-700">Show LinkedIn</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    {/* Additional Links */}
                                    <div className="bg-white border border-gray-200 rounded-lg p-6">
                                        <h4 className="text-lg font-medium text-gray-900 mb-4">Additional Links</h4>
                                        <p className="text-sm text-gray-600 mb-4">Links like Privacy Policy, Terms of Service, etc.</p>
                                        {data.content.footer?.additional_links?.map((link, index) => (
                                            <div key={index} className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                                                <div className="flex items-center justify-between mb-3">
                                                    <h5 className="text-sm font-semibold text-gray-800">Additional Link #{index + 1}</h5>
                                                    <button
                                                        type="button"
