        ...
        <AdminLayout title={title}>
            ...
            <div className="space-y-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Action Buttons — sticky so Save is always reachable on the long form */}
                    <div className="sticky bottom-0 z-10 flex items-center justify-end space-x-4 border-t border-gray-200 bg-white/95 backdrop-blur px-4 py-3 sm:rounded-t-lg">
                        <Link
                            href={route('admin.websites.show', website.id)}
                            className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        >
