            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <Link href={route('admin.buildings.import')}>
                            <button className="inline-flex items-center px-4 py-2.5 bg-white border border-[#e2e8f0] text-[#0f172a] text-sm font-medium rounded-lg hover:bg-[#f8fafc] transition-colors">
                                    ...
                                    filteredBuildings.map((building) => (
                                        <tr key={building.id} className="hover:bg-[#f8fafc] transition-colors">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right">
                                                {/* 3-dots menu — collapses View / Edit / Delete into a
                                                    single trigger so the row fits without horizontal
                                                    scroll. Popover opens to the left so it stays on-
                                                    screen at the rightmost column. */}
