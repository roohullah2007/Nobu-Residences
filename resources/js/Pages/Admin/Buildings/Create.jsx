...
export default function BuildingsCreate({ auth, developers = [], amenities = [], maintenanceFeeAmenities = [], neighbourhoods = [], subNeighbourhoods = [] }) {
    ...
    // Live MLS auto-fill: the moment an address is picked (or the field is
    // left after typing), pull the condo facts active listings carry —
    // corp number, management, year built, fees — and fill any fields the
    // admin hasn't typed yet. The after-save MLS refresh stays as the
    // safety net for address ranges and multi-address buildings.
    ...
    // Returns null when only a single address is detected.
