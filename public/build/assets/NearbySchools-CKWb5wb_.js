import{r as c,j as o}from"./app-DKiBUnyt.js";const h=({propertyData:a=null})=>{const[i,e]=c.useState(!1);`${Math.random().toString(36).substr(2,9)}`;const r=(()=>{let t=[];return a?.NearbySchools&&Array.isArray(a.NearbySchools)&&a.NearbySchools.length>0&&(t=a.NearbySchools.map(n=>({distance_km:n.Distance||"",walk_time:n.WalkTime||"",name:n.Name||"",type:n.Type||"",board:n.Board||"",url:n.URL||"#"}))),t.length===0&&(t=[{distance_km:"0.2 km",walk_time:"3 min walk",name:"St Michael's Choir (Sr) School",type:"Catholic",board:"Secondary | Toronto Catholic District School Board",url:"#"},{distance_km:"0.5 km",walk_time:"6 min walk",name:"Central Technical School",type:"Public",board:"Secondary | Toronto District School Board",url:"#"},{distance_km:"0.8 km",walk_time:"10 min walk",name:"Ryerson Community School",type:"Public",board:"Elementary | Toronto District School Board",url:"#"},{distance_km:"1.2 km",walk_time:"15 min walk",name:"Toronto Metropolitan University",type:"University",board:"Post-Secondary | Public University",url:"#"},{distance_km:"1.5 km",walk_time:"18 min walk",name:"King George Public School",type:"Public",board:"Elementary | Toronto District School Board",url:"#"}]),t})(),l=i?r:r.slice(0,3),s=r.length-3,m=()=>{e(!i)};return o.jsxs(o.Fragment,{children:[o.jsx("style",{dangerouslySetInnerHTML:{__html:`
